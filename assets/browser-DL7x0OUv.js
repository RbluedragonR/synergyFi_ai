import { d1 as ne, ai as re } from "./index-Djehc54V.js";
var V = {},
  Q,
  At;
function oe() {
      ...
      (function (r) {
        ...
        (r.getRowColCoords = function (n) {
          ...
          const t = Math.floor(n / 7) + 2,
            e = o(n),
            u = e === 145 ? 26 : Math.ceil((e - 13) / (2 * t - 2)) * 2,
            a = [e - 7];
        ...
        (r.isValid = function (t) {
          ...
          (r.getPenaltyN1 = function (t) {
            ...
            for (let I = 0; I < e; I++) {
              ...
              for (let y = 0; y < e; y++) {
                ...
                f === c
                  ? a++
                  : (a >= 5 && (u += o.N1 + (a - 5)), (c = f), (a = 1)),
                  (f = t.get(y, I)),
                  f === E
                    ? s++
                    : (s >= 5 && (u += o.N1 + (s - 5)), (E = f), (s = 1));
              }
          ...
          (r.getPenaltyN3 = function (t) {
            ...
            for (let c = 0; c < e; c++) {
              a = s = 0;
              for (let E = 0; E < e; E++)
                (a = ((a << 1) & 2047) | t.get(c, E)),
                  E >= 10 && (a === 1488 || a === 93) && u++,
                  (s = ((s << 1) & 2047) | t.get(E, c)),
                  E >= 10 && (s === 1488 || s === 93) && u++;
            }
            return u * o.N3;
          }),
...
function $t() {
  ...
  return (
    ...
    (Y.getTotalCodewordsCount = function (t, e) {
      switch (e) {
        case r.L:
          return i[(t - 1) * 4 + 0];
        case r.M:
      ...
      (function (r) {
        ...
        (r.mul = function (n, t) {
          ...
          for (let u = 0; u < n.length; u++)
            for (let a = 0; a < t.length; a++) e[u + a] ^= o.mul(n[u], t[a]);
          return e;
        }),
          (r.mod = function (n, t) {
            ...
            for (; e.length - t.length >= 0; ) {
              const u = e[0];
              for (let s = 0; s < t.length; s++) e[s] ^= o.mul(t[s], u);
              let a = 0;
  ...
  return (
    vt ||
      ...
      (function (r) {
        ...
        function s(y, f, S) {
          for (let P = 1; P <= 40; P++)
            if (f <= r.getCapacity(P, S, y)) return P;
        }
        function c(y, f) {
          return t.getCharCountIndicator(y, f) + 4;
        }
        function E(y, f) {
          let S = 0;
          return (
        ...
        function I(y, f) {
          for (let S = 1; S <= 40; S++)
            if (E(y, S) <= r.getCapacity(S, f, t.MIXED)) return S;
        }
        (r.from = function (f, S) {
          return e.isValid(f) ? parseInt(f, 10) : S;
        }),
          (r.getCapacity = function (f, S, P) {
            if (!e.isValid(f)) throw new Error("Invalid QR Code version");
            typeof P > "u" && (P = t.BYTE);
            const b = o.getSymbolTotalCodewords(f),
              N = i.getTotalCodewordsCount(f, S),
              M = (b - N) * 8;
          ...
          (r.getBestVersionForData = function (f, S) {
            let P;
            const b = n.from(S, n.M);
            if (Array.isArray(f)) {
              if (f.length > 1) return I(f, b);
              if (f.length === 0) return 1;
              P = f[0];
            } else P = f;
            return s(P.mode, P.getLength(), b);
          }),
...
function he() {
  ...
  const r = v(),
    ...
    n = r.getBCHDigit(o);
  return (
    (st.getEncodedBits = function (e, u) {
      const a = (e.bit << 3) | u;
      let s = a << 10;
      for (; r.getBCHDigit(s) - n >= 0; ) s ^= o << (r.getBCHDigit(s) - n);
      return ((a << 10) | s) ^ i;
    }),
    st
  );
...
function me() {
  ...
  return (
    ...
    (o.prototype.write = function (n) {
      ...
      a > 0 &&
        ((e = this.data.substr(t)), (u = parseInt(e, 10)), n.put(u, a * 3 + 1));
    }),
    (ct = o),
    ct
  );
      ...
      (ft = function (o) {
        for (var i = [], n = o.length, t = 0; t < n; t++) {
          ...
          if (e >= 55296 && e <= 56319 && n > t + 1) {
            ...
            u >= 56320 &&
              u <= 57343 &&
              ((e = (e - 55296) * 1024 + u - 56320 + 65536), (t += 1));
          }
          if (e < 128) {
            i.push(e);
            continue;
...
function Be() {
  return (
    Yt ||
      ...
      (function (r) {
        ...
        function I(N) {
          const M = E(u.NUMERIC, o.NUMERIC, N),
            R = E(u.ALPHANUMERIC, o.ALPHANUMERIC, N);
          let B, p;
          return (
            a.isKanjiModeEnabled()
              ? ((B = E(u.BYTE, o.BYTE, N)), (p = E(u.KANJI, o.KANJI, N)))
              : ((B = E(u.BYTE_KANJI, o.BYTE, N)), (p = [])),
            M.concat(R, B, p)
              .sort(function (w, m) {
                return w.index - m.index;
              })
              .map(function (w) {
                return { data: w.data, mode: w.mode, length: w.length };
              })
          );
        }
        function y(N, M) {
          switch (M) {
            ...
            case o.KANJI:
              return e.getBitsLength(N);
            case o.BYTE:
              return t.getBitsLength(N);
          }
        }
        function f(N) {
          return N.reduce(function (M, R) {
            const B = M.length - 1 >= 0 ? M[M.length - 1] : null;
            return B && B.mode === R.mode
              ? ((M[M.length - 1].data += R.data), M)
              : (M.push(R), M);
          }, []);
        }
        function S(N) {
        ...
        function P(N, M) {
          ...
          for (let d = 0; d < N.length; d++) {
            ...
            for (let l = 0; l < w.length; l++) {
              const A = w[l],
                g = "" + d + l;
              m.push(g), (R[g] = { node: A, lastCount: 0 }), (B[g] = {});
              for (let C = 0; C < p.length; C++) {
                const h = p[C];
                R[h] && R[h].node.mode === A.mode
                  ? ((B[h][g] =
                      y(R[h].lastCount + A.length, A.mode) -
                      y(R[h].lastCount, A.mode)),
                    (R[h].lastCount += A.length))
                  : (R[h] && (R[h].lastCount = A.length),
                    (B[h][g] =
                      y(A.length, A.mode) +
                      4 +
                      o.getCharCountIndicator(A.mode, M)));
              }
            }
            p = m;
          }
          for (let d = 0; d < p.length; d++) B[p[d]].end = 0;
          return { map: B, table: R };
        }
        function b(N, M) {
          let R;
          const B = o.getBestModeForData(N);
          if (((R = o.from(M, B)), R !== o.BYTE && R.bit < B.bit))
            throw new Error(
              '"' +
                N +
 ...
 Suggested mode is: ` +
          ...
          switch (
            (R === o.KANJI && !a.isKanjiModeEnabled() && (R = o.BYTE), R)
          ) {
            case o.NUMERIC:
              return new i(N);
            case o.ALPHANUMERIC:
        ...
        (r.fromArray = function (M) {
          return M.reduce(function (R, B) {
            return (
              typeof B == "string"
                ? R.push(b(B, null))
                : B.data && R.push(b(B.data, B.mode)),
              R
            );
          }, []);
        }),
          (r.fromString = function (M, R) {
            const B = I(M, a.isKanjiModeEnabled()),
              p = S(B),
              d = P(p, R),
              w = s.find_path(d.map, "start", "end"),
              m = [];
            for (let l = 1; l < w.length - 1; l++) m.push(d.table[w[l]].node);
            return r.fromArray(f(m));
          }),
          (r.rawSplit = function (M) {
            return r.fromArray(I(M, a.isKanjiModeEnabled()));
          });
      })(at)),
    at
  );
...
function Ae() {
  ...
  function S(d) {
    ...
    for (let m = 8; m < w - 8; m++) {
      const l = m % 2 === 0;
      d.set(m, 6, l, !0), d.set(6, m, l, !0);
    }
  }
  function P(d, w) {
    const m = t.getPositions(w);
    for (let l = 0; l < m.length; l++) {
      const A = m[l][0],
        g = m[l][1];
      for (let C = -2; C <= 2; C++)
        for (let h = -2; h <= 2; h++)
          C === -2 || C === 2 || h === -2 || h === 2 || (C === 0 && h === 0)
            ? d.set(A + C, g + h, !0, !0)
            : d.set(A + C, g + h, !1, !0);
    }
  }
  ...
  function M(d, w) {
    ...
    let l = -1,
      ...
      g = 7,
      C = 0;
    for (let h = m - 1; h > 0; h -= 2)
      for (h === 6 && h--; ; ) {
        for (let T = 0; T < 2; T++)
          if (!d.isReserved(A, h - T)) {
            let F = !1;
            C < w.length && (F = ((w[C] >>> g) & 1) === 1),
              d.set(A, h - T, F),
              g--,
              g === -1 && (C++, (g = 7));
          }
  ...
  function R(d, w, m) {
    ...
    m.forEach(function (T) {
      l.put(T.mode.bit, 4),
        l.put(T.getLength(), I.getCharCountIndicator(T.mode, d)),
        T.write(l);
    });
    const A = r.getSymbolTotalCodewords(d),
      g = a.getTotalCodewordsCount(d, w),
      C = (A - g) * 8;
    for (
      l.getLengthInBits() + 4 <= C && l.put(0, 4);
      l.getLengthInBits() % 8 !== 0;

    )
      l.putBit(0);
    const h = (C - l.getLengthInBits()) / 8;
    for (let T = 0; T < h; T++) l.put(T % 2 ? 17 : 236, 8);
    return B(l, d, w);
  }
  function B(d, w, m) {
    const l = r.getSymbolTotalCodewords(w),
      A = a.getTotalCodewordsCount(w, m),
      g = l - A,
      C = a.getBlocksCount(w, m),
      h = l % C,
      T = C - h,
      F = Math.floor(l / C),
      K = Math.floor(g / C),
    ...
    const J = new Array(C),
      yt = new Array(C);
    let O = 0;
    const ee = new Uint8Array(d.buffer);
    for (let z = 0; z < C; z++) {
      const G = z < T ? K : xt;
      (J[z] = ee.slice(_, _ + G)),
        (yt[z] = te.encode(J[z])),
    ...
    let Bt = 0,
      ...
      U;
    for (D = 0; D < O; D++)
      for (U = 0; U < C; U++) D < J[U].length && (j[Bt++] = J[U][D]);
    for (D = 0; D < Et; D++) for (U = 0; U < C; U++) j[Bt++] = yt[U][D];
    return j;
  }
  function p(d, w, m, l) {
    let A;
    if (Array.isArray(d)) A = y.fromArray(d);
    else if (typeof d == "string") {
      let F = w;
      if (!F) {
        const K = y.rawSplit(d);
        F = c.getBestVersionForData(K, m);
      }
      A = y.fromString(d, F || 40);
    } else throw new Error("Invalid data");
    const g = c.getBestVersionForData(A, m);
    if (!g)
      throw new Error(
...
`
    ...
    return (
      ...
      w >= 7 && b(T, w),
      M(T, C),
      isNaN(l) && (l = u.getBestMask(T, N.bind(null, T, m))),
      u.applyMask(l, T),
      N(T, m, l),
      {
        modules: T,
  ...
  return (
    ($.create = function (w, m) {
      if (typeof w > "u" || w === "") throw new Error("No input text");
      let l = o.M,
        A,
        g;
      return (
        typeof m < "u" &&
          ((l = o.from(m.errorCorrectionLevel, o.M)),
          (A = c.from(m.version)),
          (g = u.from(m.maskPattern)),
          m.toSJISFunc && r.setToSJISFunction(m.toSJISFunc)),
        p(w, A, l, g)
      );
    }),
    $
  ...
  return (
    Ot ||
      ...
      (function (r) {
        function o(i) {
          if (
            (typeof i == "number" && (i = i.toString()), typeof i != "string")
          )
        ...
        (r.getOptions = function (n) {
          ...
          (r.getScale = function (n, t) {
            return t.width && t.width >= n + t.margin * 2
              ? t.width / (n + t.margin * 2)
              : t.scale;
          }),
          ...
          (r.qrToImageData = function (n, t, e) {
            const u = t.modules.size,
              a = t.modules.data,
              s = r.getScale(u, e),
              c = Math.floor((u + e.margin * 2) * s),
              E = e.margin * s,
              I = [e.color.light, e.color.dark];
            for (let y = 0; y < c; y++)
              for (let f = 0; f < c; f++) {
                let S = (y * c + f) * 4,
                  P = e.color.light;
                if (y >= E && f >= E && y < c - E && f < c - E) {
                  const b = Math.floor((y - E) / s),
                    N = Math.floor((f - E) / s);
                  P = I[a[b * u + N] ? 1 : 0];
                }
                (n[S++] = P.r), (n[S++] = P.g), (n[S++] = P.b), (n[S] = P.a);
              }
          });
      })(mt)),
    mt
    ...
    jt ||
      ...
      (function (r) {
        ...
        (r.render = function (e, u, a) {
          let s = a,
            c = u;
          typeof s > "u" && (!u || !u.getContext) && ((s = u), (u = void 0)),
            u || (c = n()),
            (s = o.getOptions(s));
          const E = o.getImageWidth(e.modules.size, s),
            I = c.getContext("2d"),
            y = I.createImageData(E, E);
          return (
            o.qrToImageData(y.data, e, s),
            i(I, c, E),
          ...
          (r.renderToDataURL = function (e, u, a) {
            ...
            typeof s > "u" && (!u || !u.getContext) && ((s = u), (u = void 0)),
              s || (s = {});
            const c = r.render(e, u, s),
              E = s.type || "image/png",
              I = s.rendererOpts || {};
            return c.toDataURL(E, I.quality);
          });
      })(ht)),
    ht
  );
...
function Ie() {
  ...
  function n(t, e, u) {
    ...
    for (let I = 0; I < t.length; I++) {
      const y = Math.floor(I % e),
        f = Math.floor(I / e);
      !y && !c && (c = !0),
        t[I]
          ? (E++,
            (I > 0 && y > 0 && t[I - 1]) ||
              ((a += c ? i("M", y + u, 0.5 + f + u) : i("m", s, 0)),
              (s = 0),
              (c = !1)),
            (y + 1 < e && t[I + 1]) || ((a += i("h", E)), (E = 0)))
          : s++;
    }
    return a;
  }
  return (
    (wt.render = function (e, u, a) {
...
function Ne() {
  ...
  function t(e, u, a, s, c) {
    const E = [].slice.call(arguments, 1),
      I = E.length,
      y = typeof E[I - 1] == "function";
    if (!y && !r()) throw new Error("Callback required as last argument");
    if (y) {
      if (I < 2) throw new Error("Too few arguments provided");
      I === 2
        ? ((c = a), (a = u), (u = s = void 0))
        : I === 3 &&
          (u.getContext && typeof c > "u"
            ? ((c = s), (s = void 0))
            : ((c = s), (s = a), (a = u), (u = void 0)));
    } else {
      if (I < 1) throw new Error("Too few arguments provided");
      return (
        I === 1
          ? ((a = u), (u = s = void 0))
          : I === 2 && !u.getContext && ((s = a), (a = u), (u = void 0)),
        new Promise(function (f, S) {
          try {
            const P = o.create(a, s);
            f(e(P, u, s));
          } catch (P) {
            S(P);
          }
  ...
  return (
    (V.create = o.create),
    (V.toCanvas = t.bind(null, i.render)),
    (V.toDataURL = t.bind(null, i.renderToDataURL)),
    (V.toString = t.bind(null, function (e, u, a) {
      return n.render(e, a);
    })),
    V
  );
