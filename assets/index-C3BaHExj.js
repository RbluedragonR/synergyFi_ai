import { U as re, c as de } from "./if-defined-EXyKF6lo.js";
import { ai as ee } from "./index-Djehc54V.js";
import { i as le, r as he, a as fe, x as me } from "./index-B3oWiE09.js";
        ...
        (function (a, c) {
          ...
          var a = 1e3,
            ...
            R = {
              ...
              p: function (u) {
                return (
                  { M: T, y: b, w, d: p, D, h: $, m: y, s: f, ms: l, Q: I }[
                    u
                  ] ||
                  String(u || "")
                    .toLowerCase()
              ...
              return (
                ...
                (r.startOf = function (t, i) {
                  var n = this,
                    ...
                    g = function (k, L) {
                      var N = h.w(
                        n.$u ? Date.UTC(n.$y, L, k) : new Date(n.$y, L, k),
                        n
                      );
                    ...
                    v = function (k, L) {
                      return h.w(
                        n
                          ...
                          [k].apply(
                            n.toDate("s"),
                            (o ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(L)
                          ),
                        n
                      );
                    },
  ...
  ce = {
    ...
    getTransactionImages(e) {
      ...
      return (e == null ? void 0 : e.length) === 2 && !c
        ? [this.getTransactionImage(a), this.getTransactionImage(d)]
        : m
      ...
      return (
        e && a
          ? (d =
              (f =
                (l =
                  (m = e == null ? void 0 : e.nft_info) == null
                    ? void 0
                    : m.content) == null
                  ? void 0
                  : l.preview) == null
          ...
          : e &&
            ...
            (d =
              ($ =
                (y = e == null ? void 0 : e.fungible_info) == null
                  ? void 0
                  : y.icon) == null
                ? void 0
                : $.url),
    ...
    getTransactionDescriptions(e) {
      ...
      const d =
        ...
        c =
          ((I = e == null ? void 0 : e.transfers) == null ? void 0 : I.length) >
          0,
        m =
          ((b = e == null ? void 0 : e.transfers) == null ? void 0 : b.length) >
          1,
        l =
          c &&
          (a == null
            ? void 0
            : a.every((D) => !!(D != null && D.fungible_info))),
        [f, y] = a;
      ...
      if (!c)
        return (d === "send" || d === "receive") && l
          ? (($ = re.getTruncateString({
            ...
            [$, p])
          : [e.metadata.status];
      if (m) return a.map((D) => this.getTransferDescription(D)).reverse();
      let w = "";
      return (
        je.includes(d) ? (w = "+") : Re.includes(d) && (w = "-"),
        ($ = w.concat($)),
        [$]
      );
    },
    getTransferDescription(e) {
      ...
      return (
        e &&
          (e != null && e.nft_info
            ? (d =
                ((a = e == null ? void 0 : e.nft_info) == null
                  ? void 0
                  : a.name) || "-")
            : e != null &&
              e.fungible_info &&
              (d = this.getFungibleTransferDescription(e) || "-")),
        d
      );
    },
    getFungibleTransferDescription(e) {
      ...
      return e
        ? [
            ...
            (c = e == null ? void 0 : e.fungible_info) == null
              ? void 0
              : c.symbol,
          ]
            .join(" ")
...
var Ue = function (e, d, a, c) {
  var m = arguments.length,
    l =
      m < 3 ? d : c === null ? (c = Object.getOwnPropertyDescriptor(d, a)) : c,
    f;
