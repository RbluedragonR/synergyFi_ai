import { i as p, a as h, R as l, p as o, x as e } from "./index-B3oWiE09.js";
import { r as u, c as d } from "./if-defined-EXyKF6lo.js";
import { T as g } from "./index-BFrCxwdF.js";
const f = p`
  :host {
    --prev-height: 0px;
    --new-height: 0px;
...
var v = function (s, t, i, r) {
  var w = arguments.length,
    a =
      w < 3 ? t : r === null ? (r = Object.getOwnPropertyDescriptor(t, i)) : r,
    c;
...
let n = class extends h {
  constructor() {
    super(),
      ...
      this.unsubscribe.push(
        l.subscribeKey("view", (t) => this.onViewChange(t))
      );
  }
  firstUpdated() {
    var t;
  ...
  render() {
    return e`<div class="w3m-router-container" view-direction="${
      this.viewDirection
    }">
      ${this.viewTemplate()}
    </div>`;
