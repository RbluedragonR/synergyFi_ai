...
import { n as u, c as C, o as j } from "./if-defined-EXyKF6lo.js";
function O() {
  try {
    return c.returnOpenHref(
      `${$.SECURE_SITE_SDK_ORIGIN}/loading`,
      "popupWindow",
...
async function D(t) {
  g.setSocialProvider(t, w.state.activeChain),
    _.sendEvent({
      type: "track",
...
l.styles = [v, R, I];
d([u()], l.prototype, "logo", void 0);
d([u()], l.prototype, "name", void 0);
d([u()], l.prototype, "align", void 0);
d([u()], l.prototype, "tabIdx", void 0);
d([u({ type: Boolean })], l.prototype, "disabled", void 0);
l = d([C("wui-list-social")], l);
export { D as e };
