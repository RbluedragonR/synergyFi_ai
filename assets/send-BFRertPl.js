...
import { e as O, n as D } from "./ref-CVCDVHZs.js";
import { n as G, s as J } from "./ConstantsUtil-Dmg8YACJ.js";
import "./index-bRoVtHzS.js";
import { S as Q } from "./index-8hLfhLp3.js";
...
var E = function (o, e, i, n) {
  ...
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    ...
    for (var a = o.length - 1; a >= 0; a--)
      (s = o[a]) && (t = (r < 3 ? s(t) : r > 3 ? s(e, i, t) : s(e, i)) || t);
...
${this.value ?? ""}</textarea
  ...
  onInputChange(e) {
    ...
    const i = e.target;
    (this.pasting = !1),
      (this.value = (n = e.target) == null ? void 0 : n.value),
  ...
  dispatchInputChangeEvent(e) {
    ...
    if (i && (n = this.inputElementRef) != null && n.value)
      if (i === ",") {
        ...
        (this.inputElementRef.value.value = t),
...
C.styles = [z, W, Z];
j([d({ type: Boolean })], C.prototype, "disabled", void 0);
j([d({ type: String })], C.prototype, "value", void 0);
j([d({ type: String })], C.prototype, "placeholder", void 0);
C = j([m("wui-input-amount")], C);
const ee = f`
  :host {
    width: 100%;
    height: 100px;
  ...
  sendValueTemplate() {
    if (this.token && this.sendTokenAmount) {
      ...
      return u`<wui-text class="totalValue" variant="small-400" color="fg-200"
        >${
          i ? `$${b.formatNumberToLocalString(i, 2)}` : "Incorrect value"
        }</wui-text
      >`;
    }
    return null;
...
let h = class extends w {
  ...
  getMessage() {
    ...
    (this.message = "Preview Send"),
      this.receiverAddress &&
        !I.isAddress(this.receiverAddress, v.state.activeChain) &&
      ...
      (this.tokens =
        (e = this.tokenBalances) == null
          ...
          : e.filter((n) => {
              ...
              return (
                n.chainId ===
                ((r = v.state.activeCaipNetwork) == null
                  ? void 0
                  : r.caipNetworkId)
              );
            })),
...
let y = class extends w {
  ...
  render() {
    return u`<wui-text variant="large-500" color="fg-100">${
      this.text
    }</wui-text>
      ${this.imageTemplate()}`;
  }
...
T.styles = [z, W, re];
_([d()], T.prototype, "imageSrc", void 0);
_([d()], T.prototype, "textTitle", void 0);
_([d()], T.prototype, "textValue", void 0);
T = _([m("wui-list-content")], T);
const oe = f`
  :host {
    display: flex;
    width: auto;
...
let p = class extends w {
  constructor() {
    super(),
      ...
      this.unsubscribe.push(
        ...
        v.subscribeKey("activeCaipNetwork", (e) => (this.caipNetwork = e))
      );
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
      ...
      <wui-flex gap="xs" flexDirection="column" .padding=${[
        ...
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${
              this.sendTokenAmount
                ? b.roundNumber(this.sendTokenAmount, 6, 5)
                : "unknown"
            } ${(e = this.token) == null ? void 0 : e.symbol}"
  ...
  async onSendClick() {
    ...
    try {
      await l.sendToken(),
        B.showSuccess("Transaction started"),
        g.replace("Account");
    } catch (n) {
      ...
      F.sendEvent({
        ...
        properties: {
          message: r,
          isSmartAccount:
            M(v.state.activeChain) === Y.ACCOUNT_TYPES.SMART_ACCOUNT,
...
p.styles = se;
x([c()], p.prototype, "token", void 0);
x([c()], p.prototype, "sendTokenAmount", void 0);
x([c()], p.prototype, "receiverAddress", void 0);
x([c()], p.prototype, "receiverProfileName", void 0);
x([c()], p.prototype, "receiverProfileImageUrl", void 0);
x([c()], p.prototype, "caipNetwork", void 0);
x([c()], p.prototype, "loading", void 0);
p = x([m("w3m-wallet-send-preview-view")], p);
export {
