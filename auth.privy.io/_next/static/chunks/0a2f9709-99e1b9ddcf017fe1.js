...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8639],
  {
    2342: (e, t, r) => {
      ...
      (N.default = new N("11111111111111111111111111111111")),
        P.set(N, { kind: "struct", fields: [["_bn", "u256"]] }),
      ...
      let q = (e = "publicKey") => p.av(32, e),
        ...
        z = (e = "string") => {
          ...
          return (
            ...
            (t.alloc = (e) =>
              p.DH().span + p.DH().span + a.Buffer.from(e, "utf8").length),
            t
          );
        };
      function Y(e) {
      ...
      class $ {
        constructor(e) {
          (this.header = void 0),
            ...
            (this.accountKeys = e.accountKeys.map((e) => new N(e))),
        ...
        serialize() {
          ...
          r.forEach((e) => {
            let t = p
              .w3([
                p.u8("programIdIndex"),
                p.av(e.keyIndicesCount.length, "keyIndicesCount"),
                p.O6(p.u8("keyIndex"), e.keyIndices.length, "keyIndices"),
                p.av(e.dataLength.length, "dataLength"),
                p.O6(p.u8("userdatum"), e.data.length, "data"),
              ])
              .encode(e, s, n);
            n += t;
          }),
            (s = s.slice(0, n));
          let o = p.w3([
              p.av(1, "numRequiredSignatures"),
              p.av(1, "numReadonlySignedAccounts"),
              p.av(1, "numReadonlyUnsignedAccounts"),
              p.av(t.length, "keyCount"),
              p.O6(q("key"), e, "keys"),
              q("recentBlockhash"),
            ]),
            c = {
        ...
        static from(e) {
          ...
          for (let e = 0; e < l; e++) {
            ...
            u.push({ programIdIndex: e, accounts: i, data: o });
          }
          return new $({
            header: {
      ...
      class F {
        ...
        static compile(e) {
          ...
          let [s, n] = t.getMessageComponents(),
            a = new L(n, i).compileInstructions(e.instructions);
          return new F({
            header: s,
            staticAccountKeys: n,
            recentBlockhash: e.recentBlockhash,
        ...
        serialize() {
          ...
          let n = p.w3([
              ...
              p.av(e.length, "staticAccountKeysLength"),
              p.O6(q(), this.staticAccountKeys.length, "staticAccountKeys"),
              q("recentBlockhash"),
              p.av(r.length, "instructionsLength"),
              p.av(t.length, "serializedInstructions"),
              p.av(s.length, "addressTableLookupsLength"),
              p.av(i.length, "serializedAddressTableLookups"),
            ]),
        ...
        serializeInstructions() {
          ...
          for (let r of this.compiledInstructions) {
            ...
            let n = p.w3([
              p.u8("programIdIndex"),
              p.av(i.length, "encodedAccountKeyIndexesLength"),
              p.O6(p.u8(), r.accountKeyIndexes.length, "accountKeyIndexes"),
              p.av(s.length, "encodedDataLength"),
              p.av(r.data.length, "data"),
            ]);
            e += n.encode(
              {
        ...
        serializeAddressTableLookups() {
          ...
          for (let r of this.addressTableLookups) {
            ...
            let n = p.w3([
              q("accountKey"),
              p.av(i.length, "encodedWritableIndexesLength"),
              p.O6(p.u8(), r.writableIndexes.length, "writableIndexes"),
              p.av(s.length, "encodedReadonlyIndexesLength"),
              p.O6(p.u8(), r.readonlyIndexes.length, "readonlyIndexes"),
            ]);
            e += n.encode(
              {
        ...
        static deserialize(e) {
          ...
          for (let e = 0; e < c; e++) {
            ...
            l.push({ programIdIndex: e, accountKeyIndexes: i, data: n });
          }
          let u = Y(t),
            h = [];
          for (let e = 0; e < u; e++) {
      ...
      class Z {
        ...
        compileMessage() {
          ...
          t.forEach((e) => {
            ...
            i.forEach((e) => {
              s.push({ pubkey: new N(e), isSigner: !1, isWritable: !1 });
            });
          let n = [];
          s.forEach((e) => {
...
Missing signature for public key${
          ...
          for (let e of i) {
            ...
            for (let i of e.accountKeyIndexes) {
              ...
              (e =
                i < n
                  ? i < c
                  : i < u.staticAccountKeys.length
                  ? i - n < l
                  : i - u.staticAccountKeys.length <
                    u.accountKeysFromLookups.writable.length),
                t.push({
                  pubkey: s,
            ...
            h.push(new X({ programId: i, data: W(e.data), keys: t }));
          }
          return new Q({ payerKey: d, instructions: h, recentBlockhash: s });
        }
      ...
      class ee {
        ...
        serialize() {
          ...
          let r = p.w3([
              p.av(t.length, "encodedSignaturesLength"),
              p.O6(K(), this.signatures.length, "signatures"),
              p.av(e.length, "serializedMessage"),
            ]),
      ...
      new N("SysvarEpochSchedu1e111111111111111111111111"),
        new N("Sysvar1nstructions1111111111111111111111111");
      let er = new N("SysvarRecentB1ockHashes11111111111111111111"),
        ei = new N("SysvarRent111111111111111111111111111111111");
      new N("SysvarRewards111111111111111111111111111111"),
        new N("SysvarS1otHashes111111111111111111111111111"),
        new N("SysvarS1otHistory11111111111111111111111111");
...
` +
      ...
      let ep = (e) => ({ decode: e.decode.bind(e), encode: e.encode.bind(e) }),
        em =
          ((i = 8),
          (e) => {
            let t = (0, p.av)(8, e),
            ...
            return (
              ...
              (t.encode = (e, t, i) => r((0, m.Bq)(e, 8), t, i)),
              t
            );
          }),
        ef = Object.freeze({
      ...
      class eb {
        ...
        static transfer(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = el(ef.Transfer, { lamports: BigInt(e.lamports) })),
                (r = [
                  { pubkey: e.fromPubkey, isSigner: !0, isWritable: !0 },
                  { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
                ])),
        ...
        static assign(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = el(ef.Assign, { programId: W(e.programId.toBuffer()) })),
                (r = [
        ...
        static nonceWithdraw(e) {
          let t = el(ef.WithdrawNonceAccount, { lamports: e.lamports });
          return new X({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
        ...
        static allocate(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = el(ef.Allocate, { space: e.space })),
                (r = [
                  { pubkey: e.accountPubkey, isSigner: !0, isWritable: !0 },
                ])),
            new X({ keys: r, programId: this.programId, data: t })
        ...
        static async load(e, t, r, i, s) {
          {
            ...
            if (null !== a) {
              ...
              a.data.length !== s.length &&
                (o = o || new Z()).add(
                  eb.allocate({ accountPubkey: r.publicKey, space: s.length })
                ),
                a.owner.equals(i) ||
                  (o = o || new Z()).add(
                    eb.assign({ accountPubkey: r.publicKey, programId: i })
                  ),
                a.lamports < n &&
                  (o = o || new Z()).add(
                    eb.transfer({
            ...
            null !== o && (await eo(e, o, [t, r], { commitment: "confirmed" }));
          }
          let n = p.w3([
              p.DH("instruction"),
              p.DH("offset"),
              ...
              p.O6(p.u8("byte"), p.cY(p.DH(), -8), "bytes"),
            ]),
            o = ey.chunkSize,
            c = 0,
            l = s,
          ...
          for (; l.length > 0; ) {
            ...
            u.push(eo(e, h, [t, r], { commitment: "confirmed" })),
              e._rpcEndpoint.includes("solana.com") && (await ec(250)),
              (c += o),
              (l = l.slice(o));
          }
          await Promise.all(u);
          {
            ...
            let o = new Z().add({
              ...
              { context: u, value: d } = await e.confirmTransaction(
                {
                  signature: l,
            ...
            if (d.err)
              throw Error(`Transaction ${l} failed (${JSON.stringify(d)})`);
            for (;;) {
              try {
                if ((await e.getSlot({ commitment: c })) > u.slot) break;
              } catch {}
      ...
      (ey.chunkSize = 932),
        new N("BPFLoader2111111111111111111111111111111111");
      var ew = (function (e) {
        return e &&
          e.__esModule &&
              ...
              switch (typeof i) {
                case "object":
                  ...
                  for (a = (c = t(i).sort()).length, o = "", n = 0; n < a; )
                    void 0 !== (u = r(i[(l = c[n])], !1)) &&
                      (o && (o += ","), (o += JSON.stringify(l) + ":" + u)),
                      n++;
                  return "{" + o + "}";
                case "function":
                case "undefined":
      ...
      class e_ {
        ...
        static deserialize(e) {
          ...
          return {
            ...
            authority:
              0 !== t.authority.length ? new N(t.authority[0]) : void 0,
      ...
      function eC(e) {
        return (0, f.KC)([
          (0, f.NW)({ jsonrpc: (0, f.eu)("2.0"), id: (0, f.Yj)(), result: e }),
          (0, f.NW)({
            jsonrpc: (0, f.eu)("2.0"),
            id: (0, f.Yj)(),
            error: (0, f.NW)({
      ...
      let eT = eC((0, f.L5)());
      function eO(e) {
        return (0, f.au)(eC(e), eT, (t) =>
          "error" in t ? t : { ...t, result: (0, f.vt)(t.result, e) }
        );
      }
      function eL(e) {
        return eO(
          (0, f.NW)({ context: (0, f.NW)({ slot: (0, f.ai)() }), value: e })
        );
      }
      function eq(e) {
        return (0, f.NW)({
          context: (0, f.NW)({ slot: (0, f.ai)() }),
          value: e,
        });
      }
      function eK(e, t) {
      ...
      let ez = (0, f.NW)({
        ...
        eR = (0, f.YO)(
          (0, f.NW)({ slot: (0, f.ai)(), prioritizationFee: (0, f.ai)() })
        ),
        ej = (0, f.NW)({
          total: (0, f.ai)(),
          validator: (0, f.ai)(),
        ...
        eZ = eL(
          (0, f.NW)({
            ...
            range: (0, f.NW)({ firstSlot: (0, f.ai)(), lastSlot: (0, f.ai)() }),
          })
        ),
        eQ = eO(ez),
        e0 = eO(ej),
        ...
        tr = eL((0, f.YO)((0, f.NW)({ lamports: (0, f.ai)(), address: eW }))),
        ti = (0, f.NW)({
          executable: (0, f.zM)(),
          owner: eW,
          lamports: (0, f.ai)(),
        ...
        ts = (0, f.NW)({ pubkey: eW, account: ti }),
        tn = (0, f.au)(
          (0, f.KC)([(0, f.KJ)(a.Buffer), te]),
          (0, f.KC)([ex, te]),
          (e) => (Array.isArray(e) ? (0, f.vt)(e, eP) : e)
        ),
        ta = (0, f.NW)({
          executable: (0, f.zM)(),
          owner: eW,
        ...
        to = (0, f.NW)({ pubkey: eW, account: ta }),
        tc = (0, f.NW)({
          state: (0, f.KC)([
            (0, f.eu)("active"),
            (0, f.eu)("inactive"),
        ...
        td = (0, f.NW)({ subscription: (0, f.ai)(), result: eq(ti) }),
        th = (0, f.NW)({ pubkey: eW, account: ti }),
        tg = (0, f.NW)({ subscription: (0, f.ai)(), result: eq(th) }),
        tp = (0, f.NW)({
          parent: (0, f.ai)(),
          slot: (0, f.ai)(),
          root: (0, f.ai)(),
        }),
        tm = (0, f.NW)({ subscription: (0, f.ai)(), result: tp }),
        tf = (0, f.KC)([
          (0, f.NW)({
            type: (0, f.KC)([
              (0, f.eu)("firstShredReceived"),
              (0, f.eu)("completed"),
              (0, f.eu)("optimisticConfirmation"),
              (0, f.eu)("root"),
            ]),
            slot: (0, f.ai)(),
            timestamp: (0, f.ai)(),
        ...
        tb = (0, f.NW)({ subscription: (0, f.ai)(), result: tf }),
        ty = (0, f.NW)({
          subscription: (0, f.ai)(),
          result: eq((0, f.KC)([e$, eF])),
        }),
        tw = (0, f.NW)({ subscription: (0, f.ai)(), result: (0, f.ai)() }),
        tk = (0, f.NW)({
          pubkey: (0, f.Yj)(),
        ...
        tI = eO(
          (0, f.NW)({ current: (0, f.YO)(tS), delinquent: (0, f.YO)(tS) })
        ),
        tv = (0, f.KC)([
          (0, f.eu)("processed"),
          (0, f.eu)("confirmed"),
        ...
        tP = (0, f.NW)({
          ...
          writable: (0, f.zM)(),
          source: (0, f.lq)(
            (0, f.KC)([(0, f.eu)("transaction"), (0, f.eu)("lookupTable")])
          ),
        }),
        tE = (0, f.NW)({
        ...
        tL = (0, f.au)(tT, tO, (e) =>
          "accounts" in e ? (0, f.vt)(e, tC) : (0, f.vt)(e, tN)
        ),
        tq = (0, f.NW)({
          signatures: (0, f.YO)((0, f.Yj)()),
          message: (0, f.NW)({
        ...
        tz = (0, f.NW)({ writable: (0, f.YO)(eW), readonly: (0, f.YO)(eW) }),
        tY = (0, f.NW)({
          err: eU,
          fee: (0, f.ai)(),
          innerInstructions: (0, f.lq)(
        ...
        tR = (0, f.NW)({
          ...
          innerInstructions: (0, f.lq)(
            (0, f.me)(
              (0, f.YO)(
                (0, f.NW)({ index: (0, f.ai)(), instructions: (0, f.YO)(tL) })
              )
            )
          ),
          preBalances: (0, f.YO)((0, f.ai)()),
        ...
        tJ = eO(
          (0, f.me)(
            (0, f.NW)({
              ...
              parentSlot: (0, f.ai)(),
              transactions: (0, f.YO)(
                (0, f.NW)({ transaction: tx, meta: (0, f.me)(tY) })
              ),
              rewards: (0, f.lq)((0, f.YO)(tH)),
              blockTime: (0, f.me)((0, f.ai)()),
            })
        ...
        t3 = eL(
          (0, f.me)(
            (0, f.NW)({
              feeCalculator: (0, f.NW)({ lamportsPerSignature: (0, f.ai)() }),
            })
          )
        ),
        t2 = eO((0, f.Yj)()),
        ...
        t4 = (0, f.NW)({ result: eq(t6), subscription: (0, f.ai)() }),
        t7 = { "solana-client": "js/1.0.0-maintenance" };
      class t9 {
        constructor(e, t) {
          var r;
          let i, s, n, a, o, c;
          (this._commitment = void 0),
            ...
            (this.getBlockHeight = (() => {
              let e = {};
              return async (t) => {
                let { commitment: r, config: i } = eE(t),
              ...
              return (
                ...
                new (y())(async (r, i) => {
                  ...
                  try {
                    ...
                    t.ok
                      ? i(null, l)
                      : i(Error(`${t.status} ${t.statusText}: ${l}`));
                  } catch (e) {
        ...
        async getBalanceAndContext(e, t) {
          let { commitment: r, config: i } = eE(t),
            ...
            a = (0, f.vt)(n, eL((0, f.ai)()));
          if ("error" in a)
            throw new ea(a.error, `failed to get balance for ${e.toBase58()}`);
          return a.result;
        }
        ...
        async getBlockTime(e) {
          ...
          if ("error" in r)
            throw new ea(r.error, `failed to get block time for slot ${e}`);
          return r.result;
        }
        async getMinimumLedgerSlot() {
          let e = await this._rpcRequest("minimumLedgerSlot", []),
            t = (0, f.vt)(e, eO((0, f.ai)()));
          if ("error" in t)
            throw new ea(t.error, "failed to get minimum ledger slot");
          return t.result;
        }
        async getFirstAvailableBlock() {
          let e = await this._rpcRequest("getFirstAvailableBlock", []),
            t = (0, f.vt)(e, e5);
          if ("error" in t)
            throw new ea(t.error, "failed to get first available block");
          return t.result;
        }
        async getSupply(e) {
          let t = {};
        ...
        async getTokenAccountBalance(e, t) {
          let r = this._buildArgs([e.toBase58()], t),
            ...
            s = (0, f.vt)(i, eL(e4));
          if ("error" in s)
            throw new ea(s.error, "failed to get token account balance");
          return s.result;
        }
        async getTokenAccountsByOwner(e, t, r) {
          let { commitment: i, config: s } = eE(r),
            n = [e.toBase58()];
          "mint" in t
        ...
        async getLargestAccounts(e) {
          let t = { ...e, commitment: (e && e.commitment) || this.commitment },
            ...
            s = (0, f.vt)(i, tr);
          if ("error" in s)
            throw new ea(s.error, "failed to get largest accounts");
          return s.result;
        }
        async getTokenLargestAccounts(e, t) {
          let r = this._buildArgs([e.toBase58()], t),
            ...
            s = (0, f.vt)(i, e7);
          if ("error" in s)
            throw new ea(s.error, "failed to get token largest accounts");
          return s.result;
        }
        ...
        async getMultipleParsedAccounts(e, t) {
          let { commitment: r, config: i } = eE(t),
            ...
            o = (0, f.vt)(a, eL((0, f.YO)((0, f.me)(ta))));
          if ("error" in o)
            throw new ea(o.error, `failed to get info for accounts ${s}`);
          return o.result;
        }
        async getMultipleAccountsInfoAndContext(e, t) {
          let { commitment: r, config: i } = eE(t),
            ...
            a = await this._rpcRequest("getMultipleAccounts", n),
            o = (0, f.vt)(a, eL((0, f.YO)((0, f.me)(ti))));
          if ("error" in o)
            throw new ea(o.error, `failed to get info for accounts ${s}`);
          return o.result;
        }
        ...
        async getStakeActivation(e, t, r) {
          let { commitment: i, config: s } = eE(t),
        ...
        async getProgramAccounts(e, t) {
          let { commitment: r, config: i } = eE(t),
            ...
            a = this._buildArgs([e.toBase58()], r, s || "base64", {
              ...n,
              ...(n.filters ? { filters: eN(n.filters) } : null),
            }),
            o = await this._rpcRequest("getProgramAccounts", a),
            c = (0, f.YO)(ts),
            l =
              !0 === n.withContext ? (0, f.vt)(o, eL(c)) : (0, f.vt)(o, eO(c));
          if ("error" in l)
            throw new ea(
              l.error,
        ...
        async confirmTransactionUsingDurableNonceStrategy({
          ...
          let a,
            ...
            { abortConfirmation: l, confirmationPromise: u } =
              this.getTransactionConfirmationPromise({
                commitment: e,
                signature: n,
              }),
        ...
        async getClusterNodes() {
          ...
          if ("error" in t)
            throw new ea(t.error, "failed to get cluster nodes");
          return t.result;
        }
        async getVoteAccounts(e) {
          let t = this._buildArgs([], e),
            ...
            i = (0, f.vt)(r, tI);
          if ("error" in i)
            throw new ea(i.error, "failed to get vote accounts");
          return i.result;
        }
        async getSlot(e) {
          let { commitment: t, config: r } = eE(e),
            i = this._buildArgs([], t, void 0, r),
            s = await this._rpcRequest("getSlot", i),
            n = (0, f.vt)(s, eO((0, f.ai)()));
        ...
        async getSignatureStatuses(e, t) {
          ...
          let i = await this._rpcRequest("getSignatureStatuses", r),
            s = (0, f.vt)(i, tA);
          if ("error" in s)
            throw new ea(s.error, "failed to get signature status");
          return s.result;
        }
        async getTransactionCount(e) {
          let { commitment: t, config: r } = eE(e),
            ...
            n = (0, f.vt)(s, eO((0, f.ai)()));
          if ("error" in n)
            throw new ea(n.error, "failed to get transaction count");
          return n.result;
        }
        ...
        async getInflationReward(e, t, r) {
          let { commitment: i, config: s } = eE(r),
            ...
            o = (0, f.vt)(a, eY);
          if ("error" in o)
            throw new ea(o.error, "failed to get inflation reward");
          return o.result;
        }
        async getInflationRate() {
          let e = await this._rpcRequest("getInflationRate", []),
            t = (0, f.vt)(e, e0);
          if ("error" in t)
            throw new ea(t.error, "failed to get inflation rate");
          return t.result;
        }
        ...
        async getEpochSchedule() {
          let e = await this._rpcRequest("getEpochSchedule", []),
            t = (0, f.vt)(e, e3);
          if ("error" in t)
            throw new ea(t.error, "failed to get epoch schedule");
          let r = t.result;
          return new eS(
            r.slotsPerEpoch,
        ...
        async getLeaderSchedule() {
          let e = await this._rpcRequest("getLeaderSchedule", []),
            t = (0, f.vt)(e, e2);
          if ("error" in t)
            throw new ea(t.error, "failed to get leader schedule");
          return t.result;
        }
        ...
        async getRecentPerformanceSamples(e) {
          let t = await this._rpcRequest(
            ...
            r = (0, f.vt)(t, t8);
          if ("error" in r)
            throw new ea(r.error, "failed to get recent performance samples");
          return r.result;
        }
        async getFeeCalculatorForBlockhash(e, t) {
          let r = this._buildArgs([e], t),
            ...
            s = (0, f.vt)(i, t3);
          if ("error" in s)
            throw new ea(s.error, "failed to get fee calculator");
        ...
        async getFeeForMessage(e, t) {
          ...
          if ("error" in n)
            throw new ea(n.error, "failed to get fee for message");
        ...
        async getRecentPrioritizationFees(e) {
          let t = e?.lockedWritableAccounts?.map((e) => e.toBase58()),
            ...
            s = (0, f.vt)(i, e1);
          if ("error" in s)
            throw new ea(s.error, "failed to get recent prioritization fees");
          return s.result;
        }
        ...
        async getLatestBlockhashAndContext(e) {
          let { commitment: t, config: r } = eE(e),
            ...
            n = (0, f.vt)(s, tQ);
          if ("error" in n)
            throw new ea(n.error, "failed to get latest blockhash");
          return n.result;
        }
                  ...
                  ? {
                      ...
                      transactions: t.transactions.map(
                        ({ transaction: e, meta: t, version: r }) => ({
                          meta: t,
                          transaction: { ...e, message: eK(r, e.message) },
                          version: r,
                        })
                      ),
                    }
        ...
        async getBlockProduction(e) {
          ...
          let i = this._buildArgs([], r, "base64", t),
            ...
            n = (0, f.vt)(s, eZ);
          if ("error" in n)
            throw new ea(n.error, "failed to get block production information");
          return n.result;
        }
        ...
        async getParsedTransactions(e, t) {
          ...
          return (await this._rpcBatchRequest(s)).map((e) => {
            let t = (0, f.vt)(e, tZ);
            if ("error" in t)
              throw new ea(t.error, "failed to get transactions");
            return t.result;
          });
        }
        ...
        async getConfirmedBlock(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t),
            ...
            s = (0, f.vt)(i, tJ);
          if ("error" in s)
            throw new ea(s.error, "failed to get confirmed block");
          let n = s.result;
        ...
        async getParsedConfirmedTransaction(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t, "jsonParsed"),
            ...
            s = (0, f.vt)(i, tZ);
          if ("error" in s)
            throw new ea(s.error, "failed to get confirmed transaction");
          return s.result;
        }
        async getParsedConfirmedTransactions(e, t) {
          ...
          return (await this._rpcBatchRequest(r)).map((e) => {
            let t = (0, f.vt)(e, tZ);
            if ("error" in t)
              throw new ea(t.error, "failed to get confirmed transactions");
            return t.result;
          });
        }
        ...
        async getSignaturesForAddress(e, t, r) {
          let i = this._buildArgsAtLeastConfirmed([e.toBase58()], r, void 0, t),
            ...
            n = (0, f.vt)(s, tu);
          if ("error" in n)
            throw new ea(n.error, "failed to get signatures for address");
          return n.result;
        }
        async getAddressLookupTable(e, t) {
          ...
          return (
            null !== i &&
              (s = new e_({ key: e, state: e_.deserialize(i.data) })),
            { context: r, value: s }
          );
        }
        async getNonceAndContext(e, t) {
          let { context: r, value: i } = await this.getAccountInfoAndContext(
            ...
            s = null;
          return (
            null !== i && (s = eg.fromAccountData(i.data)),
            { context: r, value: s }
          );
        }
        async getNonce(e, t) {
        ...
        async requestAirdrop(e, t) {
          let r = await this._rpcRequest("requestAirdrop", [e.toBase58(), t]),
            i = (0, f.vt)(r, t2);
          if ("error" in i)
            throw new ea(i.error, `airdrop to ${e.toBase58()} failed`);
          return i.result;
        }
        ...
        async getStakeMinimumDelegation(e) {
          let { commitment: t, config: r } = eE(e),
            ...
            n = (0, f.vt)(s, eL((0, f.ai)()));
          if ("error" in n)
            throw new ea(n.error, "failed to get stake minimum delegation");
          return n.result;
        }
        async simulateTransaction(e, t, r) {
          ...
          if ("message" in e) {
            ...
            let o = [s, n],
              ...
              l = (0, f.vt)(c, eX);
            if ("error" in l)
              throw Error("failed to simulate transaction: " + l.error.message);
            return l.result;
          }
          if (
            (e instanceof Z
        ...
        _wsOnAccountNotification(e) {
          let { result: t, subscription: r } = (0, f.vt)(e, td);
        ...
        _wsOnProgramAccountNotification(e) {
          let { result: t, subscription: r } = (0, f.vt)(e, tg);
        ...
        onProgramAccountChange(e, t, r, i) {
          let { commitment: s, config: n } = eE(r),
            a = this._buildArgs(
              [e.toBase58()],
              s || this._commitment || "finalized",
              "base64",
              n || (i ? { filters: eN(i) } : void 0)
            );
          return this._makeSubscription(
            {
              callback: t,
        ...
        _wsOnLogsNotification(e) {
          let { result: t, subscription: r } = (0, f.vt)(e, t4);
          this._handleServerNotification(r, [t.value, t.context]);
        }
        _wsOnSlotNotification(e) {
          let { result: t, subscription: r } = (0, f.vt)(e, tm);
        ...
        _wsOnSlotUpdatesNotification(e) {
          let { result: t, subscription: r } = (0, f.vt)(e, tb);
          this._handleServerNotification(r, [t]);
        }
        onSlotUpdate(e) {
          return this._makeSubscription(
        ...
        _wsOnSignatureNotification(e) {
          let { result: t, subscription: r } = (0, f.vt)(e, ty);
        ...
        _wsOnRootNotification(e) {
          let { result: t, subscription: r } = (0, f.vt)(e, tw);
          this._handleServerNotification(r, [t]);
        }
        onRootChange(e) {
          return this._makeSubscription(
      ...
      class re {
        ...
        static fromSecretKey(e, t) {
          ...
          return new re({ publicKey: r, secretKey: e });
        }
        static fromSeed(e) {
          let t = v(e),
            r = new Uint8Array(64);
          return r.set(e), r.set(t, 32), new re({ publicKey: t, secretKey: r });
        }
        get publicKey() {
      ...
      let rt = Object.freeze({
        ...
        FreezeLookupTable: { index: 1, layout: p.w3([p.DH("instruction")]) },
        ExtendLookupTable: {
          index: 2,
          layout: p.w3([
            p.DH("instruction"),
            em(),
            p.O6(q(), p.cY(p.DH(), -8), "addresses"),
          ]),
        },
        ...
        CloseLookupTable: { index: 4, layout: p.w3([p.DH("instruction")]) },
      });
      class rr {
        constructor() {}
        static createLookupTable(e) {
          let [t, r] = N.findProgramAddressSync(
              [e.authority.toBuffer(), (0, m.Bq)(BigInt(e.recentSlot), 8)],
              this.programId
            ),
            i = el(rt.CreateLookupTable, {
            ...
            s = [
              ...
              { pubkey: eb.programId, isSigner: !1, isWritable: !1 },
            ];
      ...
      let rn = p.w3([
        p.u8("numSignatures"),
        p.u8("padding"),
        p.NX("signatureOffset"),
        p.NX("signatureInstructionIndex"),
        p.NX("publicKeyOffset"),
        p.NX("publicKeyInstructionIndex"),
        p.NX("messageDataOffset"),
        p.NX("messageDataSize"),
        p.NX("messageInstructionIndex"),
      ]);
      class ra {
        constructor() {}
        static createInstructionWithPublicKey(e) {
          ...
          return (
            ...
            l.fill(i, o),
            l.fill(r, c),
            new X({ keys: [], programId: ra.programId, data: l })
          );
        }
      ...
      class ru {
        ...
        static createInstructionWithEthAddress(e) {
          ...
          return (
            ...
            u.fill(W(i), rl.span),
            new X({ keys: [], programId: ru.programId, data: u })
          );
        }
        static createInstructionWithPrivateKey(e) {
          let { privateKey: t, message: r, instructionIndex: i } = e;
      ...
      let rg = Object.freeze({
        Initialize: {
          ...
          layout: p.w3([
            p.DH("instruction"),
            ((e = "authorized") => p.w3([q("staker"), q("withdrawer")], e))(),
            ((e = "lockup") =>
              p.w3(
                [p.Wg("unixTimestamp"), p.Wg("epoch"), q("custodian")],
                e
              ))(),
          ]),
        },
        Authorize: {
          ...
          layout: p.w3([
            p.DH("instruction"),
            q("newAuthorized"),
            p.DH("stakeAuthorizationType"),
          ]),
        },
        Delegate: { index: 2, layout: p.w3([p.DH("instruction")]) },
        Split: {
          index: 3,
          layout: p.w3([p.DH("instruction"), p.Wg("lamports")]),
        },
        ...
        Deactivate: { index: 5, layout: p.w3([p.DH("instruction")]) },
        Merge: { index: 7, layout: p.w3([p.DH("instruction")]) },
        AuthorizeWithSeed: {
          index: 8,
          layout: p.w3([
            p.DH("instruction"),
      ...
      class rp {
        ...
        static delegate(e) {
          ...
          return new Z().add({
            keys: [
              ...
              { pubkey: rd, isSigner: !1, isWritable: !1 },
        ...
        static authorize(e) {
          let {
            ...
            o = [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: et, isSigner: !1, isWritable: !0 },
              { pubkey: r, isSigner: !0, isWritable: !1 },
            ];
          return (
        ...
        static authorizeWithSeed(e) {
          ...
          return (
            o && l.push({ pubkey: o, isSigner: !0, isWritable: !1 }),
            new Z().add({ keys: l, programId: this.programId, data: c })
          );
        }
      ...
      (rp.programId = new N("Stake11111111111111111111111111111111111111")),
        (rp.space = 200);
      ...
      class rf {
        ...
        static updateValidatorIdentity(e) {
          let {
            ...
            s = el(rm.UpdateValidatorIdentity);
          return new Z().add({
            keys: [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: i, isSigner: !0, isWritable: !1 },
      ...
      (rf.programId = new N("Vote111111111111111111111111111111111111111")),
        (rf.space = 3762),
        new N("Va1idator1nfo111111111111111111111111111111"),
        (0, f.NW)({
          name: (0, f.Yj)(),
        ...
        new N("Vote111111111111111111111111111111111111111"),
        p.w3([
          q("nodePubkey"),
          q("authorizedWithdrawer"),
          p.u8("commission"),
          p.I0(),
          p.O6(
            p.w3([p.I0("slot"), p.DH("confirmationCount")]),
            p.cY(p.DH(), -8),
            "votes"
          ),
          p.u8("rootSlotValid"),
          ...
          p.I0(),
          p.O6(
            p.w3([p.I0("epoch"), q("authorizedVoter")]),
            p.cY(p.DH(), -8),
            "authorizedVoters"
          ),
          p.w3(
            [
              p.O6(
                p.w3([
                  q("authorizedPubkey"),
                  p.I0("epochOfLastAuthorizedSwitch"),
                  p.I0("targetEpoch"),
                ]),
                32,
                "buf"
          ...
          p.I0(),
          p.O6(
            p.w3([p.I0("epoch"), p.I0("credits"), p.I0("prevCredits")]),
            p.cY(p.DH(), -8),
            "epochCredits"
          ),
          p.w3([p.I0("slot"), p.I0("timestamp")], "lastTimestamp"),
        ]);
    },
  },
]);
