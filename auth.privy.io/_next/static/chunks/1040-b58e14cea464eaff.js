  ...
  [1040],
  {
    91040: (e, t, r) => {
      ...
      let { toString: c } = Object.prototype,
        ...
        v = h("FileList"),
        x = h("URLSearchParams"),
        [C, N, j, _] = ["ReadableStream", "Request", "Response", "Headers"].map(
          h
        );
      ...
      let U =
        ...
        z = "0123456789",
        H = { DIGIT: z, ALPHA: M, ALPHA_DIGIT: M + M.toUpperCase() + z },
        J = h("AsyncFunction"),
        W =
          ...
          function u(e, r, o) {
            ...
            if (e && !o && "object" == typeof e) {
              if (V.endsWith(r, "{}"))
                ...
                var u;
                if (
                  (V.isArray(e) && ((u = e), V.isArray(u) && !u.some(Z))) ||
          ...
          transformRequest: [
            function (e, t) {
              ...
              if (
                ...
                return o ? JSON.stringify(ew(e)) : e;
              if (
                V.isArrayBuffer(e) ||
                V.isBuffer(e) ||
                V.isStream(e) ||
      ...
      let eH = (e) => {
          ...
          if (
            ...
            (r.url = ea(eI(r.baseURL, r.url), e.params, e.paramsSerializer)),
            l &&
              a.set(
                "Authorization",
                "Basic " +
          ...
          if (
            ...
            (o && V.isFunction(o) && (o = o(r)), o || (!1 !== o && eD(r.url)))
          ) {
            let e = i && s && eq.read(s);
            e && a.set(i, e);
          }
          ...
          function (e) {
            return new Promise(function (t, r) {
              ...
              m.open(l.method.toUpperCase(), l.url, !0),
                ...
                (m.onabort = function () {
                  m &&
                    (r(new $("Request aborted", $.ECONNABORTED, e, m)),
                    (m = null));
                }),
                (m.onerror = function () {
              ...
              if (b && -1 === eg.protocols.indexOf(b)) {
                r(
                  new $("Unsupported protocol " + b + ":", $.ERR_BAD_REQUEST, e)
                );
                return;
              }
              m.send(u || null);
        ...
        e7 = {
          getAdapter: (e) => {
            ...
            for (let i = 0; i < n; i++) {
              ...
              if (
                ((r = t = e[i]),
                !e8(t) && void 0 === (r = e3[(n = String(t)).toLowerCase()]))
              )
      ...
      class ts {
        ...
        getUri(e) {
          return ea(
            eI((e = ez(this.defaults, e)).baseURL, e.url),
            e.params,
            e.paramsSerializer
          );
        }
      ...
      (tu.Axios = ts),
        ...
        (tu.mergeConfig = ez),
        (tu.AxiosHeaders = eC),
        (tu.formToJSON = (e) => ew(V.isHTMLForm(e) ? new FormData(e) : e)),
