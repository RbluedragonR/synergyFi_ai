  ...
  [741],
  {
    ...
    1971: (e, t, r) => {
      ...
      class o extends n.C {
        constructor(
          e,
          { code: t, docsPath: r, metaMessages: n, name: o, shortMessage: s }
        ) {
          super(s, {
            cause: e,
            docsPath: r,
    ...
    2753: (e, t, r) => {
      ...
      function d(e, t = {}) {
        ...
        return (
          t.size &&
            (a(r, { size: t.size }), (r = (0, o.B)(r, { dir: "right" }))),
    ...
    4486: (e, t, r) => {
      ...
      function c(
        e,
        { abi: t, address: r, args: c, docsPath: u, functionName: l, sender: f }
      ) {
        let d =
            e instanceof o.$S
              ? e
              ...
              : {},
          { code: h, data: p, details: y, message: g, shortMessage: m } = d,
          b =
            e instanceof n.O
              ? new o.rR({ functionName: l })
              : [3, a.bq.code].includes(h) && (p || y || g || m)
              ? new o.M({
                  abi: t,
    ...
    6499: (e, t, r) => {
      ...
      function h(e, t) {
        ...
        for (let t = 0; t < e.length; ++t) {
          let r = e[t];
          h.setPosition(y);
          let [o, s] = (function e(t, r, { staticPosition: o }) {
            let s = (0, d.k)(r.type);
            if (s) {
              let [n, i] = s;
              return (function (t, r, { length: n, staticPosition: i }) {
                if (!n) {
                  ...
                  for (let n = 0; n < s; ++n) {
                    ...
                    let [i, s] = e(t, r, { staticPosition: o });
                    (c += s), l.push(i);
                  }
                ...
                let o = 0,
                  s = [];
                for (let a = 0; a < n; ++a) {
                  let [n, a] = e(t, r, { staticPosition: i + o });
                  (o += a), s.push(n);
                }
                return [s, o];
            ...
            if ("bool" === r.type) {
              var l;
              return (l = t), [(0, u.Pr)(l.readBytes(32), { size: 32 }), 32];
            }
    ...
    7532: (e, t, r) => {
          ...
          function e(t = {}) {
            ...
            async function s(e) {
              ...
              let r = (function (e) {
                ...
                for (let t of ["request", "options", "response"])
                  Object.defineProperty(s, t, { get: () => e[t] });
                for (let [t, r] of [
                  ["data", "_data"],
                  ["status", "status"],
                  ["statusCode", "status"],
              ...
              throw (
                (Error.captureStackTrace && Error.captureStackTrace(r, a), r)
              );
            }
            let a = async function (e, a = {}) {
                ...
                let u = {
                  ...
                  options: (function (e, t, r, n) {
                    ...
                    let o = (function (e, t, r) {
                      ...
                      let n = new r(t);
                      if (e)
                        for (let [t, i] of Symbol.iterator in e ||
                        Array.isArray(e)
                          ? e
                          : new r(e))
                          n.set(t, i);
                    ...
                    return (
                      ...
                      { ...r, ...t, query: i, params: i, headers: o }
                    );
                  })(e, a, t.defaults, i),
                  response: void 0,
                  error: void 0,
                ...
                if (
                  ...
                  u.options.onRequest && (await et(u, u.options.onRequest)),
                  ...
                  u.options.body &&
                    ...
                    ((function (e) {
                      ...
                      ? ((u.options.body =
                        ...
                        (u.options.headers = new i(u.options.headers || {})),
                        u.options.headers.has("content-type") ||
                          u.options.headers.set(
                            "content-type",
                            "application/json"
                          ),
                ...
                try {
                  ...
                  return (
                    ...
                    u.options.onRequestError &&
                      (await et(u, u.options.onRequestError)),
                    await s(u)
                  );
                } finally {
                  c && clearTimeout(c);
                ...
                if (
                  ...
                  !en.has(u.response.status) &&
                  "HEAD" !== u.options.method
                ) {
                  let e =
                    (u.options.parseResponse
                      ? "json"
                      : u.options.responseType) ||
                    (function (e = "") {
                      if (!e) return "json";
                      let t = e.split(";").shift() || "";
                      return ee.test(t)
                        ? "json"
                        : X.has(t) || t.startsWith("text/")
                        ? "text"
                        : "blob";
                  ...
                  switch (e) {
                    case "json": {
                      let e = await u.response.text(),
                        t = u.options.parseResponse || n.Ay;
                ...
                !u.options.ignoreResponseError &&
                  ...
                  ? (u.options.onResponseError &&
                      (await et(u, u.options.onResponseError)),
                    await s(u))
                  : u.response;
              },
            ...
            return (
              ...
              (c.create = (r = {}, n = {}) =>
                e({
                  ...t,
                  ...n,
                  defaults: { ...t.defaults, ...n.defaults, ...r },
                })),
              c
            );
          },
      ...
      function C(e) {
        return I("string" == typeof e ? e : JSON.stringify(e))
          .replace(m, "%2B")
          .replace(A, "+")
          .replace(d, "%23")
          .replace(h, "%26")
            ...
            ? "xn--" +
                (function (e) {
                  ...
                  for (s && t.push("-"); d < r; ) {
                    ...
                    let h = d + 1;
                    for (let p of (r - n > a((0x7fffffff - i) / h) &&
                      u("overflow"),
                    (i += (r - n) * h),
                    (n = r),
                    e))
                      if (
                        (p < n && ++i > 0x7fffffff && u("overflow"), p == n)
                      ) {
                        let e = i;
                        for (let r = 36; ; r += 36) {
      ...
      function R(e) {
        return Object.keys(e)
          ...
          .map((t) => {
            var r;
            return (("number" == typeof (r = e[t]) || "boolean" == typeof r) &&
              (r = String(r)),
            r)
              ? Array.isArray(r)
                ? r.map((e) => `${B(t)}=${C(e)}`).join("&")
                : `${B(t)}=${C(r)}`
              : B(t);
          })
          .filter(Boolean)
      ...
      function N(e, t = {}) {
        return ("boolean" == typeof t && (t = { acceptRelative: t }), t.strict)
          ? M.test(e)
          : U.test(e) || (!!t.acceptRelative && k.test(e));
      }
      function L(e = "", t) {
      ...
      function H(e = "", t) {
        ...
        if (!N(e, { acceptRelative: !0 })) return t ? H(t + e) : D(e);
        let [, n = "", i, o = ""] =
            e
              .replace(/\\/g, "/")
              .match(/^[\s\0]*([\w+.-]{2,}:)?\/\/([^/@]+@)?(.*)/) || [],
        ...
        let { pathname: c, search: u, hash: l } = D(a);
        return {
      ...
      function G(e = "") {
        let [t, r] = e.split(":");
        return { username: T(t), password: T(r) };
      }
      function W(e = "") {
        let [t, r] = (e.match(/([^/:]*):?(\d+)?/) || []).splice(1);
        return { hostname: T(t), port: r };
      }
        ...
        if ("eip1559" === l) {
          ...
          let t =
              "bigint" == typeof u?.maxPriorityFeePerGas
                ...
                : await (0, o.N)(e, { block: y, chain: c, request: u }),
            r = p(y.baseFeePerGas);
          return {
    ...
    13416: (e, t, r) => {
      ...
      async function o(e) {
        ...
        return (0, n.x)({ hash: (0, i.C)(t), signature: r ?? t });
      }
    },
    13635: (e, t, r) => {
      "use strict";
    ...
    14282: (e, t, r) => {
      ...
      var n = r(57833),
        i = r(57767),
        o = r(98114);
      async function s(e, { account: t = e.account, message: r }) {
    ...
    15557: (e, t, r) => {
      ...
      var n = r(4379);
      let i = new Map();
      function o({ fn: e, id: t, shouldSplitBatch: r, wait: o = 0, sort: s }) {
        let a = async () => {
            let t = l();
            c();
        ...
        return {
          flush: c,
          async schedule(e) {
            let { promise: t, resolve: i, reject: s } = (0, n.Y)();
            return (
              (r?.([...u(), e]) && a(), l().length > 0)
                  ...
                  let r = (function e(t, r, n) {
                    for (let i in t) {
                      ...
                      if (
                        ...
                        return e(s.components, a.components, n[i]);
                      let c = [s.type, a.type];
                      if (
    ...
    17255: (e, t, r) => {
      "use strict";
      r.d(t, { Ar: () => l, Pr: () => c, Sk: () => u, U8: () => a });
      var n = r(48421),
        i = r(5359),
        o = r(2753),
        s = r(98114);
      function a(e, t = {}) {
        void 0 !== t.size && (0, o.Sl)(e, { size: t.size });
        let r = (0, s.My)(e, t);
        return (0, o.uU)(r, t);
      }
      function c(e, t = {}) {
        ...
        if (
          (void 0 !== t.size &&
            ((0, o.Sl)(r, { size: t.size }), (r = (0, i.B)(r))),
          r.length > 1 || r[0] > 1)
        )
          throw new n.xO(r);
        return !!r[0];
...
`),
    ...
    24129: (e, t, r) => {
      ...
      async function s(e, t) {
        ...
        if (!r)
          throw new i.T({ docsPath: "/docs/actions/wallet/signTypedData" });
        let u = (0, n.J)(r),
          l = { EIP712Domain: (0, o.H4)({ domain: s }), ...t.types };
        if (
          ((0, o.$$)({ domain: s, message: a, primaryType: c, types: l }),
          u.signTypedData)
        )
        ...
        let f = (0, o.v8)({ domain: s, message: a, primaryType: c, types: l });
        return e.request(
    ...
    24315: (e, t, r) => {
      ...
      async function u(e, t) {
        ...
        let y = u ? (0, n.J)(u) : null,
          g = (0, o.p)({ abi: r, args: f, functionName: h });
        try {
          return await (0, a.T)(
            e,
            c.v,
    ...
    25572: (e, t, r) => {
      ...
      let w = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
      function v(e) {
        return e >= w._0 && e <= w._9
          ? e - w._0
          : e >= w.A && e <= w.F
          ? e - (w.A - 10)
          : e >= w.a && e <= w.f
    ...
    27848: (e, t, r) => {
      ...
      async function c({ hash: e, signature: t }) {
        let n = (0, i.q)(e) ? e : (0, a.nj)(e),
          { secp256k1: c } = await Promise.resolve().then(r.bind(r, 66248)),
          l = (() => {
            if ("object" == typeof t && "r" in t && "s" in t) {
              let { r: e, s: r, v: n, yParity: i } = t,
                o = u(Number(i ?? n));
              return new c.Signature((0, s.uU)(e), (0, s.uU)(r)).addRecoveryBit(
                o
              );
            }
      ...
      async function l({ hash: e, signature: t }) {
        return (0, n.M)(await c({ hash: e, signature: t }));
      }
    },
    29063: (e, t, r) => {
      "use strict";
    ...
    29618: (e, t, r) => {
      ...
      function u(e) {
        let {
          ...
          d = t ? (0, n.J)(t) : void 0;
        if (d && !(0, c.P)(d.address)) throw new o.M({ address: d.address });
        if (f && !(0, c.P)(f)) throw new o.M({ address: f });
        if (void 0 !== r && (void 0 !== u || void 0 !== l)) throw new a.n3();
        if (u && u > i.Ao) throw new s.BG({ maxFeePerGas: u });
        if (l && u && l > u)
    ...
    32073: (e, t, r) => {
      ...
      async function u(e, t) {
        ...
        let {
          ...
          h = (0, a.A)(["waitForCallsStatus", e.uid, n]),
          { promise: p, resolve: y, reject: g } = (0, s.Y)(),
          m = (0, i.lB)(h, { resolve: y, reject: g }, (t) => {
            let i = (0, o.w)(
              async () => {
                let o = (e) => {
      ...
      Object.defineProperty(o, "defaultMaxListeners", {
        ...
        (o.prototype.emit = function (e) {
          ...
          if ("function" == typeof c) n(c, this, t);
            ...
            for (var u = c.length, l = p(c, u), r = 0; r < u; ++r)
              n(l[r], this, t);
          return !0;
        }),
        ...
        try {
          ...
          let r = await (async () =>
            t.to
              ...
              ? await (0, s.g)({ authorization: w[0] }).catch(() => {
                  throw new o.C(
          ...
          if ($?.type === "json-rpc" || null === $) {
            let t;
            null !== d &&
              ((t = await (0, f.T)(e, p.T, "getChainId")({})),
              (0, a.v)({ currentChainId: t, chain: d }));
          ...
          if ($?.type === "local") {
            let t = await (0, f.T)(
              ...
              i = await $.signTransaction(t, { serializer: n });
            return await (0, f.T)(
              e,
              g.L,
              "sendRawTransaction"
          ...
          throw (0, c.p)(e, { ...t, account: $, chain: t.chain || void 0 });
        }
      }
    },
    41287: (e, t, r) => {
      ...
      async function u(e, t) {
        ...
        try {
          ...
          let [t, i] = await Promise.all([
            r ? Promise.resolve(r) : (0, o.T)(e, s.g, "getBlock")({}),
            (0, o.T)(e, a.L, "getGasPrice")({}),
          ]);
      ...
      r.d(t, {
        D0: () =>
          function e(t, r, h = !1, m = {}) {
            ...
            let { nBitLength: A, nByteLength: P } = (function (e, t) {
              void 0 !== t && (0, i.Fe)(t);
            ...
            let S = Object.freeze({
              ...
              fromBytes: (e) => {
                if (e.length !== P)
                  throw Error(
                    "Field.fromBytes: expected " + P + " bytes, got " + e.length
                  );
...
${(0, o.E)(t)}`);
    ...
    45823: (e, t, r) => {
      ...
      function c(e) {
        let { domain: t = {}, message: r, primaryType: n } = e,
          o = { EIP712Domain: (0, a.H4)({ domain: t }), ...e.types };
        (0, a.$$)({ domain: t, message: r, primaryType: n, types: o });
        let c = ["0x1901"];
        return (
          t && c.push(u({ domain: t, types: o })),
          "EIP712Domain" !== n &&
            c.push(l({ data: r, primaryType: n, types: o })),
          (0, s.S)((0, i.xW)(c))
        );
      }
      ...
      function l({ data: e, primaryType: t, types: r }) {
        let i = (function e({ data: t, primaryType: r, types: i }) {
          ...
          for (let u of i[r]) {
            let [r, l] = (function t({ types: r, name: i, type: a, value: c }) {
              if (void 0 !== r[a])
                return [
                  { type: "bytes32" },
                  (0, s.S)(e({ data: c, primaryType: a, types: r })),
                ];
              if ("bytes" === a) {
                let e = c.length % 2 ? "0" : "";
                return (
                  (c = `0x${e + c.slice(2)}`),
                  [{ type: "bytes32" }, (0, s.S)(c)]
                );
              }
              if ("string" === a)
                return [{ type: "bytes32" }, (0, s.S)((0, o.nj)(c))];
              if (a.lastIndexOf("]") === a.length - 1) {
                let e = a.slice(0, a.lastIndexOf("[")),
                  o = c.map((n) => t({ name: i, type: e, types: r, value: n }));
                return [
                  { type: "bytes32" },
                  (0, s.S)(
                    (0, n.h)(
          ...
          { abi: r, functionName: l } =
            1 === e.abi.length && e.functionName?.startsWith("0x")
              ...
              : (function (e) {
                  ...
                  return { abi: [i], functionName: (0, s.V)((0, a.B)(i)) };
                })(e),
          f = r[0],
          d = "inputs" in f && f.inputs ? (0, i.h)(f.inputs, t ?? []) : void 0;
    ...
    51642: (e, t, r) => {
      ...
      function S(e, t, r, n, o) {
        return (
          (t *= 1),
          (r >>>= 0),
          o || P(e, t, r, 4, 34028234663852886e22, -34028234663852886e22),
      ...
      function I(e, t, r, n, o) {
        return (
          (t *= 1),
          (r >>>= 0),
          o || P(e, t, r, 8, 17976931348623157e292, -17976931348623157e292),
      ...
      function O(e, t, r, n, i, o) {
        ...
        $(i, "offset"),
          (void 0 === n[i] || void 0 === n[i + o]) && R(i, n.length - (o + 1));
      }
      function $(e, t) {
        if ("number" != typeof e)
      ...
      function R(e, t, r) {
        if (Math.floor(e) !== e)
          throw (
            ($(e, r), new C.ERR_OUT_OF_RANGE(r || "offset", "an integer", e))
          );
    ...
    55476: (e, t, r) => {
      ...
      async function w(e, t) {
        ...
        let {
          ...
          T = v ? (0, n.J)(v) : v,
          O = { ...t, ...(T ? { from: T?.address } : {}) };
        async function $() {
          return (
            r ||
            (r = await (0, h.T)(e, s.g, "getBlock")({ blockTag: "latest" }))
          );
        }
        async function R() {
          return (
            ...
            (E
              ...
              : void 0 !== t.chainId
              ? t.chainId
              : (w = await (0, h.T)(e, g.T, "getChainId")({})))
          );
        }
        ...
        if (
          ...
          let e = (0, u.S)({ blobs: x, kzg: P });
          if (
            (C.includes("blobVersionedHashes") &&
              (O.blobVersionedHashes = (0, f.d)({ commitments: e, to: "hex" })),
            C.includes("sidecars"))
          ) {
            let t = (0, l.t)({ blobs: x, commitments: e, kzg: P });
            O.sidecars = (0, d.T)({
              blobs: x,
              commitments: e,
              proofs: t,
        ...
        if (
          (C.includes("chainId") && (O.chainId = await R()),
        ...
        return (
          C.includes("gas") &&
            ...
            (O.gas = await (0, h.T)(
              ...
              ...O,
              account: T ? { address: T.address, type: "json-rpc" } : T,
            })),
          (0, p.c)(O),
          delete O.parameters,
          O
    ...
    56318: (e, t, r) => {
      ...
      function f(
        ...
        return {
          ...
          request: (function (e, t = {}) {
            return async (r, l = {}) => {
              let {
                ...
                { method: g } = r;
              if (
                d?.exclude?.includes(g) ||
                (d?.include && !d.include.includes(g))
              )
          ...
          })(f, { methods: t, retryCount: d, retryDelay: h, uid: (0, l.L)() }),
          value: g,
        };
      }
    },
    ...
    62048: (e, t, r) => {
      ...
      var i = r(19600),
        ...
        s = r(98114);
      function a(e, t) {
        let r = n((0, i.q)(e, { strict: !1 }) ? (0, o.ZJ)(e) : e);
    ...
    62117: (e, t, r) => {
      ...
      var n = r(66248),
        i = r(2753),
        o = r(31652);
      function s({ r: e, s: t, to: r = "hex", v: s, yParity: a }) {
        let c = (() => {
            if (0 === a || 1 === a) return a;
          ...
          u = `0x${new n.secp256k1.Signature(
            (0, i.uU)(e),
            (0, i.uU)(t)
          ).toCompactHex()}${0 === c ? "1b" : "1c"}`;
        return "hex" === r ? u : (0, o.aT)(u);
      }
    },
    62822: (e, t, r) => {
      "use strict";
      r.d(t, { b4: () => o, gU: () => a, uP: () => s });
      var n = r(2753),
        i = r(94428);
      let o = {
        "0x0": "legacy",
    ...
    63645: (e, t, r) => {
      ...
      let i = (function () {
        ...
        s = i.Headers,
        a = i.AbortController,
        c = (0, n.c)({ fetch: o, Headers: s, AbortController: a });
    },
    63719: (e, t, r) => {
      "use strict";
      r.d(t, { A: () => n });
    ...
    65628: (e, t, r) => {
      ...
      async function h(e, t = {}) {
        let { account: r = e.account, chainId: n } = t,
          i = r ? (0, d.J)(r) : void 0,
          s = n ? [i?.address, [(0, o.cK)(n)]] : [i?.address],
          a = await e.request({ method: "wallet_getCapabilities", params: s }),
          c = {};
      ...
      async function A(e, t) {
        ...
        if (!r) throw new E.T({ docsPath: "/docs/eip7702/signAuthorization" });
        let n = (0, d.J)(r);
      ...
      async function T(e, t) {
        let { account: r = e.account, chain: n = e.chain, ...s } = t;
        if (!r)
          throw new E.T({ docsPath: "/docs/actions/wallet/signTransaction" });
        let a = (0, d.J)(r);
        (0, B.c)({ account: a, ...t });
        let c = await (0, C.T)(e, i.T, "getChainId")({});
        null !== n && (0, S.v)({ currentChainId: c, chain: n });
          ...
          : await e.request(
              {
                ...
                params: [{ ...l(s), chainId: (0, o.cK)(c), from: a.address }],
              },
              { retryCount: 0 }
            );
      }
      ...
      function k(e) {
        return {
          ...
          deployContract: (t) =>
            (function (e, t) {
              let { abi: r, args: n, bytecode: i, ...o } = t,
                s = (0, a.m)({ abi: r, args: n, bytecode: i });
              return (0, c.v)(e, {
                ...o,
    ...
    65772: (e, t, r) => {
      ...
      class c extends n.ol {
        ...
        process(e, t) {
          ...
          let { A: r, B: i, C: c, D: u, E: l, F: f, G: d, H: h } = this;
          for (let e = 0; e < 64; e++) {
            let t =
                (h +
      ...
      class p extends n.ol {
        ...
        process(e, t) {
          ...
          ({ h: r, l: n } = i.WQ(0 | this.Ah, 0 | this.Al, 0 | r, 0 | n)),
            ({ h: o, l: s } = i.WQ(0 | this.Bh, 0 | this.Bl, 0 | o, 0 | s)),
            ({ h: a, l: c } = i.WQ(0 | this.Ch, 0 | this.Cl, 0 | a, 0 | c)),
            ({ h: u, l: p } = i.WQ(0 | this.Dh, 0 | this.Dl, 0 | u, 0 | p)),
            ({ h: y, l: g } = i.WQ(0 | this.Eh, 0 | this.El, 0 | y, 0 | g)),
            ({ h: m, l: b } = i.WQ(0 | this.Fh, 0 | this.Fl, 0 | m, 0 | b)),
            ({ h: w, l: v } = i.WQ(0 | this.Gh, 0 | this.Gl, 0 | w, 0 | v)),
            ({ h: x, l: E } = i.WQ(0 | this.Hh, 0 | this.Hl, 0 | x, 0 | E)),
            this.set(r, n, o, s, a, c, u, p, y, g, m, b, w, v, x, E);
        }
        roundClean() {
          (0, o.uH)(d, h);
        }
    ...
    66248: (e, t, r) => {
      ...
      let x = {
          ...
          toSig(e) {
            let { Err: t, _int: r, _tlv: n } = x,
              i = (0, o.qj)("signature", e),
              { v: s, l: a } = n.decode(48, i);
            if (a.length)
              throw new t("invalid signature: left bytes after parsing");
            let { v: c, l: u } = n.decode(2, s),
                ...
                v = (function (e, t, r = {}) {
                  ...
                  class p {
                    ...
                    static fromCompact(e) {
                      ...
                      return new p(
                        l.fromBytes(r.subarray(0, t)),
                        l.fromBytes(r.subarray(t, 2 * t))
                      );
                    }
                    static fromDER(e) {
                      let { r: t, s: r } = x.toSig((0, o.qj)("DER", e));
                      return new p(t, r);
                    }
                    assertValidity() {}
                    addRecoveryBit(e) {
                    ...
                    normalizeS() {
                      return this.hasHighS()
                        ? new p(this.r, l.neg(this.s), this.recovery)
                        : this;
                    }
                    toBytes(e) {
                      if ("compact" === e)
                        return (0, s.Id)(l.toBytes(this.r), l.toBytes(this.s));
                  ...
                  function g(t) {
                    ...
                    let n = (0, o.qj)("key", t).length,
                      i = u.BYTES,
                      s = i + 1;
                    if (!r.allowedPrivateKeyLengths && l.BYTES !== s)
                      return n === s || n === 2 * i + 1;
                  }
                  let m =
                      t.bits2int ||
                  ...
                  return (
                    ...
                    Object.freeze({
                      ...
                      sign: function (r, i, a = I) {
                        let { seed: d, k2sig: h } = (function (r, i, a = I) {
                          if (["recovered", "canonical"].some((e) => e in a))
                            throw Error("sign() legacy options not supported");
                          let { hash: c } = t,
                            { lowS: d, prehash: h, extraEntropy: g } = a;
                          null == d && (d = !0),
                            (r = (0, o.qj)("msgHash", r)),
                            w(a),
                            h && (r = (0, o.qj)("prehashed msgHash", c(r)));
                          let v = b(r),
                            x = y(i),
                            P = [S(x), S(v)];
                          if (null != g && !1 !== g) {
                      ...
                      verify: function (r, n, i, a = T) {
                        let c, u;
                        (n = (0, o.qj)("msgHash", n)),
                          (i = (0, o.qj)("publicKey", i)),
                          w(a);
                        let { lowS: f, prehash: d, format: h } = a;
                        if ("strict" in a)
                          throw Error("options.strict was renamed to lowS");
                        if (
                          void 0 !== h &&
                          !["compact", "der", "js"].includes(h)
                        )
                          throw Error(
                        ...
                        let { r: m, s: v } = u,
                          ...
                          P = l.create(E * A),
                          S = l.create(m * A),
                          I = e.BASE.multiplyUnsafe(P).add(c.multiplyUnsafe(S));
                  ...
                  (function (e, t = {}) {
                    var r, n, i, w;
                    let { Fp: v, Fn: x } = (function (e, t, r = {}) {
                        if (!t || "object" != typeof t)
                          throw Error(`expected valid ${e} CURVE object`);
                        for (let e of ["p", "n", "h"]) {
                          let r = t[e];
                          if (!("bigint" == typeof r && r > c))
                    ...
                    let R =
                        ...
                        function (e, t, r) {
                          let { x: n, y: i } = t.toAffine(),
                            a = v.toBytes(n);
                          if (((0, o.e8)("isCompressed", r), !r))
                            return (0, s.Id)(Uint8Array.of(4), a, v.toBytes(i));
                          {
                            $();
                            let e = !v.isOdd(i);
                            return (0, s.Id)(B(e), a);
                    ...
                    let F = (0, o.x)((e, t) => {
                        ...
                        if (v.eql(i, v.ONE)) return { x: r, y: n };
                        let o = e.is0();
                        null == t && (t = o ? v.ONE : v.inv(i));
                        let s = v.mul(r, t),
                          a = v.mul(n, t),
                          c = v.mul(i, t);
                        if (o) return { x: v.ZERO, y: v.ZERO };
                    ...
                    function q(e, t, r, n, i) {
                      return (
                        (r = new H(v.mul(r.px, e), r.py, r.pz)),
                        (t = l(n, t)),
                        (r = l(i, r)),
                        t.add(r)
                      );
                    ...
                    class H {
                      ...
                      static fromAffine(e) {
                        let { x: t, y: r } = e || {};
                        if (!e || !v.isValid(t) || !v.isValid(r))
                          throw Error("invalid affine point");
                        if (e instanceof H)
                          throw Error("projective point not allowed");
                        return v.is0(t) && v.is0(r)
                          ? H.ZERO
                          : new H(t, r, v.ONE);
                      }
                      get x() {
                      ...
                      precompute(e = 8, t = !0) {
                        return (
                          G.setWindowSize(this, e), t || this.multiply(S), this
                        );
                      }
                      _setWindowSize(e) {
                        this.precompute(e);
                      ...
                      equals(e) {
                        ...
                        let { px: t, py: r, pz: n } = this,
                          { px: i, py: o, pz: s } = e,
                          a = v.eql(v.mul(t, s), v.mul(i, n)),
                          c = v.eql(v.mul(r, s), v.mul(o, n));
                        return a && c;
                      }
                      negate() {
                      ...
                      isTorsionFree() {
                        ...
                        return (
                          P === A ||
                          (e ? e(H, this) : G.wNAFCachedUnsafe(this, T).is0())
                        );
                      }
                      clearCofactor() {
                    ...
                    (H.BASE = new H(e.Gx, e.Gy, v.ONE)),
                      (H.ZERO = new H(v.ZERO, v.ONE, v.ZERO)),
                      (H.Fp = v),
                      (H.Fn = x);
                    let D = x.BITS,
                      G =
                        ((r = t.endo ? Math.ceil(D / 2) : D),
                        {
                          constTimeNegate: l,
                          ...
                          precomputeWindow(e, t) {
                            let { windows: n, windowSize: i } = d(t, r),
                              o = [],
                              s = e,
                              a = s;
                            for (let e = 0; e < n; e++) {
        ...
        if ("name" in e && "inputs" in e && e.inputs)
          return `${r ? e.name : ""}(${e.inputs
            .map(
              (e, r) =>
                `${n && e.name ? `${e.name}: ` : ""}${
                  "object" == typeof t[r] ? (0, a.A)(t[r]) : t[r]
                }`
            )
            .join(", ")})`;
      }
        ...
        constructor(
          ...
          let b = t ? (0, n.J)(t) : void 0,
            w = (0, y.aO)({
              ...
              value:
                void 0 !== g &&
                `${(0, l.c)(g)} ${i?.nativeCurrency?.symbol || "ETH"}`,
              data: o,
              gas: s,
...
${(0, p.uj)(m)}`),
      ...
      class b extends h.C {
        constructor(
          ...
          let l = (0, u.iY)({ abi: t, args: r, name: o }),
            f = l
              ? c({
                  abiItem: l,
                  args: r,
              ...
              : void 0,
            d = l ? (0, s.B)(l, { includeName: !0 }) : void 0,
            h = (0, y.aO)({
              address: n && (0, g.R)(n),
              function: d,
              args:
      ...
      async function p(e, t) {
        ...
        try {
          ...
          if (
            ...
            return { id: (0, a.xW)([...n, (0, u.cK)(y.id, { size: 32 }), d]) };
          }
          throw (0, l.p)(r, { ...t, account: x, chain: t.chain });
        }
      }
    },
    74994: (e, t, r) => {
      ...
      function l(e) {
        let { data: t, kzg: r, to: l } = e,
          ...
          d = e.commitments ?? (0, n.S)({ blobs: f, kzg: r, to: l }),
          h = e.proofs ?? (0, i.t)({ blobs: f, commitments: d, kzg: r, to: l }),
          p = [];
        for (let e = 0; e < f.length; e++)
          p.push({ blob: f[e], commitment: d[e], proof: h[e] });
        return p;
      }
    },
    75156: (e, t, r) => {
      ...
      function i({ chain: e, currentChainId: t }) {
        if (!e) throw new n.jF();
        if (t !== e.id) throw new n.EH({ chain: e, currentChainId: t });
      }
    },
    77520: (e, t, r) => {
      "use strict";
          ...
          super(e.shortMessage, {
            ...
            metaMessages: [
              ...
              (0, u.aO)({
                ...
                value:
                  void 0 !== p &&
                  `${(0, a.c)(p)} ${n?.nativeCurrency?.symbol || "ETH"}`,
                data: i,
                gas: o,
      ...
      async function w(e, t) {
        ...
        try {
          let {
            ...
            T = ("bigint" == typeof f ? (0, s.cK)(f) : void 0) || d,
            O = (0, y.yH)(C),
            $ = await (async () =>
              B.to
                ? B.to
          ...
          let U = BigInt(
            await c({ block: T, request: M, rpcStateOverride: O })
          );
          if (n) {
            let t = await (0, b.r)(e, { address: M.from }),
              r = await Promise.all(
                n.map(async (e) => {
                  let { address: r } = e,
                    n = await c({
      ...
      function c(e) {
        let { chainId: t, nonce: r, to: c } = e,
          ...
          l = (0, a.S)(
            (0, n.aP)([
              "0x05",
              (0, s.EQ)([t ? (0, o.cK)(t) : "0x", u, r ? (0, o.cK)(r) : "0x"]),
            ])
          );
    ...
    84442: (e, t, r) => {
      ...
      function s(e, t, r) {
        let s = ++o,
          ...
          l = a();
        if ((n.set(e, [...l, { id: s, fns: t }]), l && l.length > 0)) return u;
        let f = {};
        for (let e in t)
          f[e] = (...t) => {
            let r = a();
      ...
      function i(e, { emitOnBegin: t, initialWaitTime: r, interval: i }) {
        ...
        return (
          (async () => {
            ...
            await (0, n.u)(c);
            let u = async () => {
              o && (await e({ unpoll: s }), await (0, n.u)(i), u());
            };
            u();
          })(),
          s
    ...
    94086: (e, t, r) => {
      ...
      function l(e, t = {}) {
        ...
        return ({ chain: l, retryCount: b, timeout: w }) => {
          let { batchSize: v = 1e3, wait: x = 0 } =
              "object" == typeof r ? r : {},
            E = t.retryCount ?? b,
            A = w ?? t.timeout ?? 1e4,
            P = e || l?.rpcUrls.default.http[0];
          if (!P) throw new o();
          let S = (function (e, t = {}) {
            return {
              async request(r) {
                let {
                  ...
                  l = { ...(t.fetchOptions ?? {}), ...(r.fetchOptions ?? {}) },
                  { headers: f, method: d, signal: h } = l;
                try {
                  let t;
          ...
          })(P, { fetchOptions: i, onRequest: p, onResponse: y, timeout: A });
          return (0, u.o)(
            {
              key: f,
              methods: d,
              ...
              async request({ method: e, params: t }) {
                let i = { method: e, params: t },
                  ...
                  a = async (e) => (r ? o(e) : [await S.request({ body: e })]),
                  [{ error: c, result: u }] = await a(i);
                if (m) return { error: c, result: u };
                if (c) throw new n.J8({ body: i, error: c, url: P });
                return u;
              },
              retryCount: E,
              retryDelay: g,
    ...
    94718: (e, t, r) => {
      ...
      var n = r(57833),
        ...
        c = r(81573);
      async function u(e, t) {
        let { account: r = e.account, chainId: u, nonce: l } = t;
        if (!r)
          throw new i.T({ docsPath: "/docs/eip7702/prepareAuthorization" });
        let f = (0, n.J)(r),
          d = (() => {
            if (t.executor)
              return "self" === t.executor ? t.executor : (0, n.J)(t.executor);
          })(),
          h = { address: t.contractAddress ?? t.address, chainId: u, nonce: l };
        return (
          void 0 === h.chainId &&
            (h.chainId =
              e.chain?.id ?? (await (0, s.T)(e, a.T, "getChainId")({}))),
          void 0 === h.nonce &&
            ((h.nonce = await (0, s.T)(
              e,
              c.y,
            ...
            ("self" === d || (d?.address && (0, o.h)(d.address, f.address))) &&
              (h.nonce += 1)),
          h
        );
      }
    ...
    96362: (e, t, r) => {
      ...
      function y(e) {
        let { domain: t, message: r, primaryType: n, types: i } = e,
          ...
          a = i.EIP712Domain && t ? s(i.EIP712Domain, t) : {},
          c = (() => {
            if ("EIP712Domain" !== n) return s(i[n], r);
          })();
        return (0, o.A)({ domain: a, message: c, primaryType: n, types: i });
      }
      function g(e) {
        let { domain: t, message: r, primaryType: o, types: s } = e,
          p = (e, t) => {
            for (let r of e) {
              let { name: e, type: o } = r,
                a = t[e],
              ...
              if ("address" === o && "string" == typeof a && !(0, l.P)(a))
                throw new i.M({ address: a });
              let y = o.match(h.BD);
              if (y) {
                let [e, t] = y;
                if (t && (0, f.E)(a) !== Number.parseInt(t))
                  throw new n.BI({
        ...
        if (s.EIP712Domain && t) {
          if ("object" != typeof t) throw new a({ domain: t });
          p(s.EIP712Domain, t);
        }
        if ("EIP712Domain" !== o) {
          if (s[o]) p(s[o], r);
      ...
      function b({ domain: e }) {
        return (0, p.xy)({
          domain: e,
          types: { EIP712Domain: m({ domain: e }) },
        });
      }
    },
    96752: (e, t, r) => {
      "use strict";
      r.d(t, { r0: () => n, iU: () => el, jU: () => T, Vv: () => et });
      var n = {};
      r.r(n), r.d(n, { decode: () => eu, encode: () => ec });
      ...
      let A = (e, t, r = 0) => {
        ...
        S = async (e, t, r, n, i) => {
          ...
          switch (n) {
            ...
            case "EdDSA":
              (s = { name: P(c) }), (a = u ? ["verify"] : ["sign"]);
              break;
            default:
              throw new h('Invalid or unsupported "alg" (Algorithm) value');
          }
          return x.subtle.importKey(
            t,
            c,
            s,
            null !== (o = null == i ? void 0 : i.extractable) &&
              void 0 !== o &&
              o,
            a
          );
        ...
        I = (e, t, r) =>
          S(/(?:-----(?:BEGIN|END) PUBLIC KEY-----|\s)/g, "spki", e, t, r),
        C = async (e) => {
          var t, r;
          if (!e.alg)
            throw TypeError(
          ...
          let { algorithm: n, keyUsages: i } = (function (e) {
              let t, r;
              switch (e.kty) {
                case "oct":
                  switch (e.alg) {
            ...
            o = [
              ...
              null !== (r = e.key_ops) && void 0 !== r ? r : i,
            ];
          if ("PBKDF2" === n.name)
            return x.subtle.importKey("raw", c(e.k), ...o);
          let s = { ...e };
              ...
              return (
                !(function (e, t, ...r) {
                  switch (t) {
                    ...
                    case "RS384":
                    case "RS512": {
                      if (!U(e.algorithm, "RSASSA-PKCS1-v1_5"))
      ...
      async function K(e, t, r) {
        ...
        let l = { ...u, ...e.header },
          f = $(p, new Map([["b64", !0]]), null == r ? void 0 : r.crit, u, l),
          h = !0;
        if (f.has("b64") && "boolean" != typeof (h = u.b64))
          throw new p(
        ...
        if (g && !g.has(y))
          throw new d('"alg" (Algorithm) Header Parameter not allowed');
        if (h) {
        ...
        let m = !1;
        "function" == typeof t && ((t = await t(u, e)), (m = !0)),
          G(y, t, "verify");
        let b = (function (...e) {
          ...
          i.encode(null !== (n = e.protected) && void 0 !== n ? n : ""),
          i.encode("."),
        ...
        let w = { payload: a };
        return (void 0 !== e.protected && (w.protectedHeader = u),
      ...
      async function J(e, t, r) {
        if (
          (e instanceof Uint8Array && (e = o.decode(e)), "string" != typeof e)
        )
          throw new p("Compact JWS must be a string or Uint8Array");
        let { 0: n, 1: i, 2: s, length: a } = e.split(".");
        if (3 !== a) throw new p("Invalid Compact JWS");
        let c = await K({ payload: i, protected: n, signature: s }, t, r),
          u = { payload: c.payload, protectedHeader: c.protectedHeader };
        return "function" == typeof t ? { ...u, key: c.key } : u;
      }
      let V = (e) => Math.floor(e.getTime() / 1e3),
        ...
        ee = (e, t, r = {}) => {
          let n, i;
          let { typ: s } = r;
          if (s && ("string" != typeof e.typ || Q(e.typ) !== Q(s)))
            throw new l(
          ...
          for (let e of (void 0 !== h && a.push("iat"),
          void 0 !== d && a.push("aud"),
          void 0 !== u && a.push("sub"),
          void 0 !== c && a.push("iss"),
          new Set(a.reverse())))
            if (!(e in n))
              throw new l(`missing required "${e}" claim`, e, "missing");
          if (c && !(Array.isArray(c) ? c : [c]).includes(n.iss))
            throw new l('unexpected "iss" claim value', "iss", "check_failed");
          if (u && n.sub !== u)
            throw new l('unexpected "sub" claim value', "sub", "check_failed");
          if (d && !X(n.aud, "string" == typeof d ? [d] : d))
          ...
          let { currentDate: p } = r,
            g = V(p || new Date());
          if ((void 0 !== n.iat || h) && "number" != typeof n.iat)
      ...
      async function et(e, t, r) {
        ...
        let i = await J(e, t, r);
        if (
          (null === (n = i.protectedHeader.crit) || void 0 === n
            ? void 0
            : n.includes("b64")) &&
        ...
        return "function" == typeof t ? { ...o, key: i.key } : o;
      }
      let er = (e, t) => {
      ...
      function en(e) {
        return (
          e && "object" == typeof e && Array.isArray(e.keys) && e.keys.every(ei)
        );
      }
      function ei(e) {
        return B(e);
      ...
      class eo {
        constructor(e) {
          if (((this._cached = new WeakMap()), !en(e)))
      ...
      let ea = async (e, t, r) => {
          ...
          if ((void 0 !== i && clearTimeout(i), 200 !== s.status))
            throw new u(
        ...
        ec = (e) =>
          s(e).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_"),
        eu = c;
      function el(e) {
        let t, r;
        if ("string" != typeof e)
            ...
            for (let p = 0; p < e.length; p++)
              r.push(
                (function e({ param: t, value: r }) {
                  ...
                  if ("address" === t.type)
                    return (function (e) {
                      if (!(0, a.P)(e)) throw new i.M({ address: e });
                      return {
                        dynamic: !1,
                  ...
                  if ("bool" === t.type)
                    return (function (e) {
                      ...
                      return { dynamic: !1, encoded: (0, u.db)((0, d.$P)(e)) };
                    })(r);
    ...
    97622: (e, t, r) => {
      ...
      var n = r(19055),
        ...
        s = r(98114);
      function a(e, t) {
        let r = (0, n.lY)((0, i.q)(e, { strict: !1 }) ? (0, o.ZJ)(e) : e);
        return "bytes" === (t || "hex") ? r : (0, s.nj)(r);
      }
    },
    97701: (e, t, r) => {
