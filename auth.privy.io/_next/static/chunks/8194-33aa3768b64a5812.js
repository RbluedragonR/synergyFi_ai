  ...
  [8194],
  {
    ...
    57551: (t, e, r) => {
      ...
      function w(t, e, r = !1, c = {}) {
        ...
        let { nBitLength: g, nByteLength: m } = y(t, e);
        if (m > 2048)
        ...
        let E = Object.freeze({
          ...
          fromBytes: (t) => {
            if (t.length !== m)
              throw Error(
                "Field.fromBytes: expected " + m + " bytes, got " + t.length
              );
    ...
    64546: (t, e, r) => {
      ...
      function u(t, e) {
        return (
          s(t, e), { windows: Math.ceil(e / t) + 1, windowSize: 2 ** (t - 1) }
        );
      }
      let d = new WeakMap(),
        f = new WeakMap();
      ...
      function h(t, e) {
        return {
          ...
          wNAF(r, n, i) {
            let { windows: o, windowSize: s } = u(r, e),
              d = t.ZERO,
              f = t.BASE,
              c = BigInt(2 ** r - 1),
              h = 2 ** r,
          ...
          wNAFUnsafe(r, n, i, a = t.ZERO) {
            let { windows: s, windowSize: d } = u(r, e),
              f = BigInt(2 ** r - 1),
              c = 2 ** r,
              h = BigInt(r);
            for (let t = 0; t < s; t++) {
          ...
          getPrecomputes(t, e, r) {
            ...
            return (
              n ||
                ((n = this.precomputeWindow(e, t)), 1 !== t && d.set(e, r(n))),
              n
            );
          },
          wNAFCached(t, e, r) {
    ...
    66551: (t, e, r) => {
      ...
      var n = r(75439),
        ...
        a = r(52516);
      function s(t) {
        void 0 !== t.lowS && (0, a.e8)("lowS", t.lowS),
          void 0 !== t.prehash && (0, a.e8)("prehash", t.prehash);
      }
      let { Ph: u, aT: d } = a;
      ...
      let c = {
          ...
          toSig(t) {
            let { Err: e, _int: r, _tlv: n } = c,
              i = "string" == typeof t ? d(t) : t;
            a.DO(i);
            let { v: o, l: l } = n.decode(48, i);
            if (l.length)
              throw new e("invalid signature: left bytes after parsing");
            let { v: s, l: u } = n.decode(2, o),
              { v: f, l: h } = n.decode(2, u);
            if (h.length)
              throw new e("invalid signature: left bytes after parsing");
          ...
          (function (t) {
            ...
            let {
                ...
                function d(t) {
                  ...
                  return (
                    o && (r = (0, l.zi)(r, s)), a.aK("private key", r, p, s), r
                  );
                }
                function f(t) {
                  if (!(t instanceof y))
                ...
                class y {
                  ...
                  equals(t) {
                    ...
                    let { px: e, py: n, pz: i } = this,
                      { px: o, py: l, pz: a } = t,
                      s = r.eql(r.mul(e, a), r.mul(o, i)),
                      u = r.eql(r.mul(n, a), r.mul(l, i));
                    return s && u;
                  }
                  negate() {
                  ...
                  multiplyUnsafe(t) {
                    ...
                    let { k1neg: l, k1: s, k2neg: u, k2: d } = n.splitScalar(t),
                      f = o,
                      c = o,
                      g = this;
                    for (; s > h || d > h; )
                    ...
                    return (
                      l && (f = f.negate()),
                      u && (c = c.negate()),
                      (c = new y(r.mul(c.px, n.beta), c.py, c.pz)),
                      f.add(c)
                    );
                  }
                  multiply(t) {
                  ...
                  toHex(t = !0) {
                    return (
                      (0, a.e8)("isCompressed", t), a.My(this.toRawBytes(t))
                    );
                  }
                }
                ...
                toBytes(t, e, n) {
                  let i = e.toAffine(),
                    o = r.toBytes(i.x),
                    l = a.Id;
                  return ((0, a.e8)("isCompressed", n), n)
              ...
              b = (t) => a.My(a.lq(t, e.nByteLength)),
              v = (t, e, r) => a.Ph(t.slice(e, r));
            class x {
              constructor(t, e, r) {
                (this.r = t),
                  (this.s = e),
              ...
              static fromCompact(t) {
                let r = e.nByteLength;
                return new x(
                  v((t = (0, a.qj)("compactSignature", t, 2 * r)), 0, r),
                  v(t, r, 2 * r)
                );
              }
              static fromDER(t) {
                let { r: e, s: r } = c.toSig((0, a.qj)("DER", t));
                return new x(e, r);
              }
              assertValidity() {
            ...
            function O(t) {
              return (
                a.aK("num < 2^" + e.nBitLength, t, h, q), a.lq(t, e.nByteLength)
              );
            }
            ...
            return (
              m.BASE._setWindowSize(8),
              {
                ...
                sign: function (t, i, o = R) {
                  let { seed: l, k2sig: u } = (function (t, i, o = R) {
                    if (["recovered", "canonical"].some((t) => t in o))
                      throw Error("sign() legacy options not supported");
                    let { hash: l, randomBytes: u } = e,
                      { lowS: c, prehash: g, extraEntropy: w } = o;
                    null == c && (c = !0),
                      (t = (0, a.qj)("msgHash", t)),
                      s(o),
                      g && (t = (0, a.qj)("prehashed msgHash", l(t)));
                    let b = A(t),
                      v = y(i),
                      B = [O(v), O(b)];
                    if (null != w && !1 !== w) {
                ...
                verify: function (t, r, n, i = N) {
                  let o, l;
                  (r = (0, a.qj)("msgHash", r)),
                    (n = (0, a.qj)("publicKey", n));
                  let { lowS: u, prehash: h, format: p } = i;
                  if ((s(i), "strict" in i))
                  ...
                  let { r: w, s: E } = l,
                    ...
                    B = d(b * v),
                    S = d(w * v),
                    q = m.BASE.multiplyAndAddUnsafe(o, B, S)?.toAffine();
                  return !!q && d(q.x) === w;
                },
                ProjectivePoint: m,
                Signature: x,
            ...
            transactions: t.transactions?.map((t) => {
              ...
              return (
                "0x7e" === e.typeHex &&
                  ...
                  (e.mint = t.mint ? i.uU(t.mint) : void 0),
        ...
        transaction: (0, l.gU)({
          format(t) {
            ...
            return (
              "0x7e" === t.type &&
                ((e.isSystemTx = t.isSystemTx),
                (e.mint = t.mint ? (0, i.uU)(t.mint) : void 0),
                (e.sourceHash = t.sourceHash),
                (e.type = "deposit")),
              e
            );
    ...
    76892: (t, e, r) => {
      ...
      function u(t, e) {
        var r;
        return "deposit" === (r = t).type || void 0 !== r.sourceHash
          ? (function (t) {
              !(function (t) {
                let { from: e, to: r } = t;
                if (e && !(0, i.P)(e)) throw new n.M({ address: e });
                if (r && !(0, i.P)(r)) throw new n.M({ address: r });
              })(t);
              let {
                  sourceHash: e,
                  data: r,
