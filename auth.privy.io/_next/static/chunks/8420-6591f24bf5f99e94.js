(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8420],
  {
    260: (e, t, r) => {
      ...
      let i = r(29067);
      (t.ZodIssueCode = i.util.arrayToEnum([
        "invalid_type",
        "invalid_literal",
        "custom",
        "invalid_union",
    ...
    14505: (e, t, r) => {
      ...
      let h = new Uint8Array(32),
        p = { amount: 0xffffffffffffffffn, script: o.wg },
        f = (e) => Math.ceil(e / 4);
      o.Lo.decimal(8);
      ...
      let w = o.w3({ txid: o.ee(32, !0), index: o.QK });
      function x(e) {
        if ("number" != typeof e || "string" != typeof n[e])
          throw Error(`Invalid SigHash=${e}`);
        return e;
      }
      function k(e) {
        let t = 31 & e;
      ...
      function A(e) {
        if (e.nonWitnessUtxo && void 0 !== e.index) {
          ...
          if (
            e.witnessUtxo &&
            (!(0, c.ex)(e.witnessUtxo.script, r.script) ||
              e.witnessUtxo.amount !== r.amount)
          )
            throw Error(
          ...
          if (e.txid) {
            ...
            if (t.isFinal && t.id !== r)
              throw Error(`nonWitnessUtxo: wrong txid, exp=${r} got=${t.id}`);
          }
        }
        return e;
      }
      ...
      function C(e, t, r, i = !1, n = !1) {
        let o,
          { nonWitnessUtxo: d, txid: h } = e;
        "string" == typeof d && (d = s.uh.decode(d)),
          (0, c.aY)(d) && (d = u.NC.decode(d)),
          "nonWitnessUtxo" in e || void 0 !== d || (d = t?.nonWitnessUtxo),
          "string" == typeof h && (h = s.uh.decode(h)),
          void 0 === h && (h = t?.txid);
        let p = { ...t, ...e, nonWitnessUtxo: d, txid: h };
        return (
          "nonWitnessUtxo" in e ||
            void 0 !== p.nonWitnessUtxo ||
            delete p.nonWitnessUtxo,
          void 0 === p.sequence && (p.sequence = 0xffffffff),
          null === p.tapMerkleRoot && delete p.tapMerkleRoot,
          (p = l.O4(l.k0, p, t, r, n)),
          l.ju.encode(p),
          p.nonWitnessUtxo && void 0 !== p.index
            ? (o = p.nonWitnessUtxo.outputs[p.index])
            : p.witnessUtxo && (o = p.witnessUtxo),
          o && !i && (0, a.wN)(o && o.script, p.redeemScript, p.witnessScript),
          p
        );
      }
      function I(e, t = !1) {
      ...
      class B {
        constructor(e = {}) {
          ...
          let t = (this.opts = (function (e) {
            if (void 0 !== e && "[object Object]" !== {}.toString.call(e))
              throw Error(`Wrong object type for transaction options: ${e}`);
            let t = {
              ...e,
            ...
            if (
              (void 0 !== t.allowUnknowInput &&
                (e.allowUnknownInputs = t.allowUnknowInput),
              void 0 !== t.allowUnknowOutput &&
                (e.allowUnknownOutputs = t.allowUnknowOutput),
              "number" != typeof t.lockTime)
            )
              throw Error("Transaction lock time should be number");
            if (
              (o.QK.encode(t.lockTime),
              0 !== t.PSBTVersion && 2 !== t.PSBTVersion)
            )
              throw Error(`Unknown PSBT version ${t.PSBTVersion}`);
            for (let e of [
              "allowUnknownVersion",
              "allowUnknownOutputs",
              "allowUnknownInputs",
              ...
              if (void 0 !== r && "boolean" != typeof r)
                throw Error(
                  `Transation options wrong type: ${e}=${r} (${typeof r})`
                );
            }
            if (
              t.allowUnknownVersion
                ? "number" == typeof t.version
                : ![-1, 0, 1, 2, 3].includes(t.version)
            )
              throw Error(`Unknown version: ${t.version}`);
            if (void 0 !== t.customScripts) {
              let e = t.customScripts;
              if (!Array.isArray(e))
                throw Error(
                  `wrong custom scripts type (expected array): customScripts=${e} (${typeof e})`
                );
              for (let t of e)
                if (
                  "function" != typeof t.encode ||
                  "function" != typeof t.decode ||
                  (void 0 !== t.finalizeTaproot &&
        ...
        static fromRaw(e, t = {}) {
          let r = u.NC.decode(e),
            i = new B({ ...t, version: r.version, lockTime: r.lockTime });
          ...
          if (((i.outputs = r.outputs), (i.inputs = r.inputs), r.witnesses))
            for (let e = 0; e < r.witnesses.length; e++)
              i.inputs[e].finalScriptWitness = r.witnesses[e];
          return i;
        }
        static fromPSBT(e, t = {}) {
          let r;
          ...
          let n = r.global.unsignedTx,
            ...
            u = new B({ ...t, version: s, lockTime: a, PSBTVersion: i }),
          ...
          return (
            (u.outputs = r.outputs
              .slice(0, d)
              .map((e, t) => ({ ...e, ...r.global.unsignedTx?.outputs[t] }))),
            (u.global = { ...r.global, txVersion: s }),
            0 !== a && (u.global.fallbackLocktime = a),
            u
          );
        }
          ...
          for (let e of t)
            e.partialSig && !e.partialSig.length && delete e.partialSig,
              e.finalScriptSig &&
                ...
                delete e.finalScriptSig,
              e.finalScriptWitness &&
                !e.finalScriptWitness.length &&
                delete e.finalScriptWitness;
          let r = this.outputs.map((t) => l.Ow(e, l.hZ, t)),
            i = { ...this.global };
          return (
            0 === e
              ? ((i.unsignedTx = u.kW.decode(
                  u.kW.encode({
                    version: this.version,
                    lockTime: this.lockTime,
                    inputs: this.inputs
                      .map(v)
                      .map((e) => ({ ...e, finalScriptSig: o.wg })),
              ...
              : ((i.version = e),
                ...
                i.fallbackLocktime &&
                  0 === i.fallbackLocktime &&
                  delete i.fallbackLocktime),
            this.opts.bip174jsCompat &&
              (t.length || t.push({}), r.length || r.push({})),
            (0 === e ? l.QX : l.QC).encode({ global: i, inputs: t, outputs: r })
          );
        }
        get lockTime() {
          let e = 0,
          ...
          for (let n of this.inputs)
            n.requiredHeightLocktime &&
              ((e = Math.max(e, n.requiredHeightLocktime)), t++),
              n.requiredTimeLocktime &&
                ((r = Math.max(r, n.requiredTimeLocktime)), i++);
          return t && t >= i
            ? e
            : 0 !== r
            ? r
        ...
        inputSighash(e) {
          ...
          return { sigInputs: r & i.ANYONECANPAY, sigOutputs: n };
        }
        signStatus() {
          let e = !0,
            t = !0,
          ...
          for (let s = 0; s < this.inputs.length; s++) {
            ...
            let { sigInputs: o, sigOutputs: a } = this.inputSighash(s);
            if ((o === i.ANYONECANPAY ? r.push(s) : (e = !1), a === i.ALL))
              t = !1;
            else if (a === i.SINGLE) n.push(s);
            else if (a === i.NONE);
            else throw Error(`Wrong signature hash output type: ${a}`);
          }
          return { addInput: e, addOutput: t, inputs: r, outputs: n };
        }
        get isFinal() {
        ...
        get weight() {
          ...
          for (let r of ((e += 4 * u.km.encode(this.outputs.length).length), t))
            e += 32 + 4 * u.Rg.encode(r.script).length;
          for (let t of (this.hasWitnesses && (e += 2),
          (e += 4 * u.km.encode(this.inputs.length).length),
          this.inputs))
            (e += 160 + 4 * u.Rg.encode(t.finalScriptSig || o.wg).length),
              this.hasWitnesses &&
                t.finalScriptWitness &&
                (e += u.Kk.encode(t.finalScriptWitness).length);
          return e;
        }
        get vsize() {
        ...
        addInput(e, t = !1) {
          if (!t && !this.signStatus().addInput)
            throw Error("Tx has signed inputs, cannot add new one");
          return (
            this.inputs.push(
              C(e, void 0, void 0, this.opts.disableScriptCheck)
            ),
        ...
        normalizeOutput(e, t, r) {
          let { amount: i, script: n } = e;
          if ((void 0 === i && (i = t?.amount), "bigint" != typeof i))
            throw Error(
              `Wrong amount type, should be of type bigint in sats, but got ${i} of type ${typeof i}`
            );
          "string" == typeof n && (n = s.uh.decode(n)),
            void 0 === n && (n = t?.script);
          let o = { ...t, ...e, amount: i, script: n };
          if (
            (void 0 === o.amount && delete o.amount,
            (o = l.O4(l.hZ, o, t, r, this.opts.allowUnknown)),
            l.AT.encode(o),
            o.script &&
              !this.opts.allowUnknownOutputs &&
              "unknown" === a._o.decode(o.script).type)
          )
            throw Error(
          ...
          return (
            this.opts.disableScriptCheck ||
              (0, a.wN)(o.script, o.redeemScript, o.witnessScript),
            o
          );
        }
        addOutput(e, t = !1) {
          if (!t && !this.signStatus().addOutput)
            throw Error("Tx has signed outputs, cannot add new one");
          return (
            this.outputs.push(this.normalizeOutput(e)), this.outputs.length - 1
          );
        }
        ...
        preimageWitnessV0(e, t, r, i) {
          let { isAny: n, isNone: s, isSingle: a } = k(r),
            l = h,
            d = h,
            p = h,
            f = this.inputs.map(v),
            g = this.outputs.map(m);
          n || (l = c.Y7(...f.map(w.encode))),
            n || a || s || (d = c.Y7(...f.map((e) => o.QK.encode(e.sequence)))),
            a || s
              ? a && e < g.length && (p = c.Y7(u.oV.encode(g[e])))
              : (p = c.Y7(...g.map(u.oV.encode)));
          let y = f[e];
          return c.Y7(
            o.eV.encode(this.version),
            l,
            d,
            o.ee(32, !0).encode(y.txid),
            o.QK.encode(y.index),
            u.Rg.encode(t),
            o.dg.encode(i),
            o.QK.encode(y.sequence),
            p,
            o.QK.encode(this.lockTime),
            o.QK.encode(r)
          );
        }
        preimageWitnessV1(e, t, r, n, s = -1, l, p = 192, f) {
          if (!Array.isArray(n) || this.inputs.length !== n.length)
            throw Error(`Invalid amounts array=${n}`);
          if (!Array.isArray(t) || this.inputs.length !== t.length)
            throw Error(`Invalid prevOutScript array=${t}`);
          let g = [
              o.U8.encode(0),
              o.U8.encode(r),
              o.eV.encode(this.version),
          ...
          b !== i.ANYONECANPAY &&
            g.push(
              ...[
                ...
                n.map(o.dg.encode),
                t.map(u.Rg.encode),
                x.map((e) => o.QK.encode(e.sequence)),
              ].map((e) => d.sc((0, c.Id)(...e)))
            ),
            y === i.ALL && g.push(d.sc((0, c.Id)(...k.map(u.oV.encode))));
          let A = +!!f | (2 * !!l);
          if ((g.push(new Uint8Array([A])), b === i.ANYONECANPAY)) {
            ...
            g.push(
              ...
              o.dg.encode(n[e]),
              u.Rg.encode(t[e]),
              o.QK.encode(r.sequence)
            );
          } else g.push(o.QK.encode(e));
          return (
            1 & A && g.push(d.sc(u.Rg.encode(f || o.wg))),
            y === i.SINGLE &&
              g.push(e < k.length ? d.sc(u.oV.encode(k[e])) : h),
            l && g.push((0, a.Me)(l, p), o.U8.encode(0), o.eV.encode(s)),
            c.m("TapSighash", ...g)
          );
        }
        signIdx(e, t, r, n) {
          ...
          if (!(0, c.aY)(e)) {
            if (!s.bip32Derivation || !s.bip32Derivation.length)
              throw Error("bip32Derivation: empty");
            let r = s.bip32Derivation
              .filter((t) => t[1].fingerprint == e.fingerprint)
              .map(([t, { path: r }]) => {
                let i = e;
                for (let e of r) i = i.deriveChild(e);
                if (!(0, c.ex)(i.publicKey, t))
                  throw Error("bip32Derivation: wrong pubKey");
                if (!i.privateKey)
                  throw Error("bip32Derivation: no privateKey");
                return i;
              });
            if (!r.length)
              throw Error(
          ...
          if (!r.includes(d))
            throw Error(
              `Input with not allowed sigHash=${d}. Allowed: ${r.join(", ")}`
            );
          let { sigOutputs: h } = this.inputSighash(t);
          if (h === i.SINGLE && t >= this.outputs.length)
            throw Error(
          ...
          if ("taproot" === l.txType) {
            ...
            if (s.tapInternalKey) {
              let { pubKey: r, privKey: a } = (function (e, t, r, i = o.wg) {
                  return (
                    (0, c.ex)(r, t) && ((e = c.Cn(e, i)), (t = c.vl(e))),
                    { privKey: e, pubKey: t }
                  );
                })(e, f, s.tapInternalKey, g),
                [u, y] = c.gD(s.tapInternalKey, g);
              if ((0, c.ex)(u, r)) {
                let e = this.preimageWitnessV1(t, l, d, h),
                  r = (0, c.Id)(
                    c.V0(e, a, n),
                    d !== i.DEFAULT ? new Uint8Array([d]) : o.wg
                  );
                this.updateInput(t, { tapKeySig: r }, !0), (p = !0);
              }
            }
            if (s.tapLeafScript)
              for (let [r, g] of ((s.tapScriptSig = s.tapScriptSig || []),
              s.tapLeafScript)) {
                let r = g.subarray(0, -1),
                  s = u.eF.decode(r),
                  y = g[g.length - 1],
                  m = (0, a.Me)(r, y);
                if (-1 === s.findIndex((e) => (0, c.aY)(e) && (0, c.ex)(e, f)))
                  continue;
                ...
                this.updateInput(
                  t,
                  { tapScriptSig: [[{ pubKey: f, leafHash: m }, b]] },
                  !0
                ),
                  (p = !0);
              }
            ...
            let i = c.E1(e),
              n = !1,
              s = c.A0(i);
            for (let e of u.eF.decode(l.lastScript))
              (0, c.aY)(e) && ((0, c.ex)(e, i) || (0, c.ex)(e, s)) && (n = !0);
            if (!n)
              throw Error(`Input script doesn't have pubKey: ${l.lastScript}`);
            if ("legacy" === l.txType)
              r = this.preimageLegacy(t, l.lastScript, d);
            else if ("segwit" === l.txType) {
              let e = l.lastScript;
              "wpkh" === l.last.type &&
                (e = a._o.encode({ type: "pkh", hash: l.last.hash })),
                (r = this.preimageWitnessV0(t, e, d, p.amount));
            } else
              throw Error(`Transaction/sign: unknown tx type: ${l.txType}`);
            let o = c.iM(r, e, this.opts.lowR);
            this.updateInput(
              t,
              { partialSig: [[i, (0, c.Id)(o, new Uint8Array([d]))]] },
              !0
            );
          }
          return !0;
        ...
        finalizeIdx(e) {
          ...
          if ((this.checkInputIdx(e), this.fee < 0n))
            throw Error("Outputs spends more than inputs amount");
          let i = this.inputs[e],
          ...
          if ("taproot" === n.txType) {
            if (i.tapKeySig) i.finalScriptWitness = [i.tapKeySig];
              ...
              for (let [e, t] of i.tapLeafScript.sort(
                (e, t) => l.u0.encode(e[0]).length - l.u0.encode(t[0]).length
              )) {
                let r = t.slice(0, -1),
                  n = t[t.length - 1],
                  s = a._o.decode(r),
                ...
                if ("tr_ms" === s.type) {
                  ...
                  for (let e of s.pubkeys) {
                    let t = h.findIndex((t) => (0, c.ex)(t[0].pubKey, e));
                    -1 !== t && p.push(h[t][1]);
                  }
                  if (p.length !== s.pubkeys.length) continue;
                } else if (
                  "unknown" === s.type &&
                  this.opts.allowUnknownInputs
                ) {
                  let e = u.eF.decode(r);
                  if (
                    !(p = h
                  ...
                  if (t)
                    for (let n of t) {
                      ...
                      if (a) {
                        (i.finalScriptWitness = a.concat(l.u0.encode(e))),
                          (i.finalScriptSig = o.wg),
                          b(i);
                        return;
                      }
                    }
          ...
          if (!i.partialSig || !i.partialSig.length)
            throw Error("Not enough partial sign");
          let s = o.wg,
            h = [];
          if ("ms" === n.last.type) {
            let e = n.last.m,
            ...
            if ((r = r.slice(0, e)).length !== e)
              throw Error(
                `Multisig: wrong signatures count, m=${e} n=${t.length} signatures=${r.length}`
              );
            s = u.eF.encode([0, ...r]);
          } else if ("pk" === n.last.type)
            s = u.eF.encode([i.partialSig[0][1]]);
          else if ("pkh" === n.last.type)
            s = u.eF.encode([i.partialSig[0][1], i.partialSig[0][0]]);
          else if ("wpkh" === n.last.type)
            (s = o.wg), (h = [i.partialSig[0][1], i.partialSig[0][0]]);
          else if ("unknown" === n.last.type && !this.opts.allowUnknownInputs)
            throw Error("Unknown inputs not allowed");
          if (
            (n.type.includes("wsh-") &&
              (s.length &&
                n.lastScript.length &&
                (h = u.eF.decode(s).map((e) => {
                  if (0 === e) return o.wg;
                  if ((0, c.aY)(e)) return e;
                  throw Error(`Wrong witness op=${e}`);
                })),
              (h = h.concat(n.lastScript))),
            "segwit" === n.txType && (r = h),
            n.type.startsWith("sh-wsh-")
              ? (t = u.eF.encode([u.eF.encode([0, d.sc(n.lastScript)])]))
              : n.type.startsWith("sh-")
              ? (t = u.eF.encode([...u.eF.decode(s), n.lastScript]))
              : n.type.startsWith("wsh-") || ("segwit" !== n.txType && (t = s)),
            !t && !r)
          )
            throw Error("Unknown error finalizing input");
        ...
        combine(e) {
          ...
          let t = this.global.unsignedTx
              ? u.kW.encode(this.global.unsignedTx)
              : o.wg,
            r = e.global.unsignedTx ? u.kW.encode(e.global.unsignedTx) : o.wg;
          if (!(0, c.ex)(t, r))
            throw Error("Transaction/combine: different unsigned tx");
          this.global = l.O4(
            l.xG,
            this.global,
            e.global,
    ...
    19408: (e, t, r) => {
      ...
      r.d(t, { Rn: () => O, jn: () => P });
      let s = 2n ** 255n - 19n,
        o = 2n ** 252n + 0x14def9dea2f79cd65812631a5cf5d3edn,
        a = {
          a: -1n,
        ...
        c = (e, t) =>
          ...
          ("number" != typeof t || !(t > 0) || e.length === t)
            ? e
            : l("Uint8Array expected"),
      ...
      class g {
        ...
        static fromAffine(e) {
          return new g(e.x, e.y, 1n, p(e.x * e.y));
        }
        static fromHex(e, t = !0) {
          ...
          let n = k(i);
          0n !== n &&
            (t && !(0n < n && n < s) && l("bad y coord 1"),
            t || (0n < n && n < 2n ** 256n) || l("bad y coord 2"));
          let o = p(n * n),
            { isValid: u, value: c } = B(p(o - 1n), p(r * o + 1n));
          u || l("bad y coordinate 3");
          let d = (1n & c) === 1n;
          return (
            ((128 & e[31]) != 0) !== d && (c = p(-c)), new g(c, n, 1n, p(c * n))
          );
        }
        get x() {
        ...
        add(e) {
          let { ex: t, ey: r, ez: i, et: n } = this,
            { ex: s, ey: o, ez: l, et: u } = f(e),
            { a: c, d } = a,
            h = p(t * s),
            y = p(r * o),
            m = p(n * d * u),
        ...
        mul(e, t = !0) {
          if (0n === e) return !0 === t ? l("cannot multiply by 0") : m;
          if (
            (("bigint" == typeof e && 0n < e && e < o) ||
              l("invalid scalar, must be < L"),
            (!t && this.is0()) || 1n === e)
          )
            return this;
          ...
          let r = m,
            i = y;
          for (let n = this; e > 0n; n = n.double(), e >>= 1n)
            1n & e ? (r = r.add(n)) : t && (i = i.add(n));
          return r;
        }
        multiply(e) {
          return this.mul(e);
      ...
      let { BASE: y, ZERO: m } = g,
        ...
        x = (e) => w(v(e, 64)).reverse(),
        k = (e) => BigInt("0x" + b(d(c(e)).reverse())),
        A = (...e) => {
        ...
        S = (e, t = s) => {
          ...
          return 1n === i ? p(n, t) : l("no inverse");
        },
        C = (e, t) => {
          let r = e;
          for (; t-- > 0n; ) (r *= r), (r %= s);
        ...
        I = (e) => {
          let t = (((e * e) % s) * e) % s,
            ...
            c = (C(u, 80n) * l) % s,
            d = (C(c, 10n) * n) % s;
          return { pow_p_5_8: (C(d, 2n) * e) % s, b2: t };
        },
        B = (e, t) => {
          let r = p(t * t * t),
        ...
        T = (e) => {
          ...
          let r = e.slice(32, 64),
            ...
            n = y.mul(i),
            s = n.toRawBytes();
          return { head: t, prefix: r, scalar: i, point: n, pointBytes: s };
        },
        N = (e) => _(h(e, 32)).then(T),
        O = (e) => N(e).then((e) => e.pointBytes),
        U = () =>
        ...
        P = {
          ...
          randomBytes: (e) => {
            let t = U();
            return (
              t || l("crypto.getRandomValues must be defined"),
              t.getRandomValues(d(e))
            );
          },
          sha512Async: async (...e) => {
            let t = U();
        ...
        switch (e.code) {
          ...
          case n.ZodIssueCode.invalid_literal:
            r = `Invalid literal value, expected ${JSON.stringify(
              e.expected,
              i.util.jsonStringifyReplacer
            )}`;
            break;
          case n.ZodIssueCode.unrecognized_keys:
            r = `Unrecognized key(s) in object: ${i.util.joinValues(
              e.keys,
              ", "
            )}`;
            break;
          ...
          case n.ZodIssueCode.invalid_union_discriminator:
            r = `Invalid discriminator value. Expected ${i.util.joinValues(
              e.options
            )}`;
            break;
          case n.ZodIssueCode.invalid_enum_value:
            r = `Invalid enum value. Expected ${i.util.joinValues(
              e.options
            )}, received '${e.received}'`;
            break;
        ...
        (h.IPv4 = (function () {
          ...
          return (
            ...
            (e.prototype.prefixLengthFromSubnetMask = function () {
              ...
              for (e = 3; e >= 0; e -= 1) {
                if (!((t = this.octets[e]) in s) || ((r = s[t]), n && 0 !== r))
                  return null;
                8 !== r && (n = !0), (i += r);
              }
              return 32 - i;
          ...
          (h.IPv4.broadcastAddressFromCIDR = function (e) {
            try {
              let t = this.parseCIDR(e),
                ...
                s = 0;
              for (; s < 4; )
                n.push(parseInt(r[s], 10) | (255 ^ parseInt(i[s], 10))), s++;
              return new this(n);
            } catch (e) {
          ...
          (h.IPv4.isValidFourPartDecimal = function (e) {
            return !!(
              h.IPv4.isValid(e) && e.match(/^(0|[1-9]\d*)(\.(0|[1-9]\d*)){3}$/)
            );
          }),
            ...
            try {
              for (
                i = (t = this.parseCIDR(e))[0].toByteArray(),
                  s = this.subnetMaskFromPrefixLength(t[1]).toByteArray(),
                  n = [],
                  r = 0;
                r < 4;

              )
                n.push(parseInt(i[r], 10) & parseInt(s[r], 10)), r++;
              return new this(n);
            } catch (e) {
              throw Error("ipaddr: the address does not have IPv4 CIDR format");
            }
          ...
          (h.IPv6 = (function () {
            ...
            return (
              ...
              (e.prototype.prefixLengthFromSubnetMask = function () {
                ...
                for (let s = 7; s >= 0; s -= 1) {
                  if (!((e = this.parts[s]) in n) || ((t = n[e]), i && 0 !== t))
                    return null;
                  16 !== t && (i = !0), (r += t);
                }
                return 128 - r;
              ...
              (e.prototype.toRFC5952String = function () {
                ...
                let t = /((^|:)(0(:|$)){2,})/g,
                  ...
                  n = -1;
                for (; (e = t.exec(r)); )
                  e[0].length > n && ((i = e.index), (n = e[0].length));
                return n < 0
                  ? r
                  : `${r.substring(0, i)}::${r.substring(i + n)}`;
              }),
              (e.prototype.toString = function () {
          ...
          (h.IPv6.parseCIDR = function (e) {
            ...
            if (
              ...
              return (
                Object.defineProperty((i = [this.parse(r[1]), t]), "toString", {
                  value: function () {
                    return this.join("/");
                  },
                }),
          ...
          (h.IPv6.parser = function (e) {
            let t, r, i, n, s, o;
            if ((i = e.match(l.deprecatedTransitional)))
              return this.parser(`::ffff:${i[1]}`);
            if (l.native.test(e)) return u(e, 8);
            if (
              (i = e.match(l.transitional)) &&
              ((o = i[6] || ""), (t = u(i[1].slice(0, -1) + o, 6)).parts)
            ) {
              for (
                r = 0,
                  s = [
              ...
              return (
                t.parts.push((s[0] << 8) | s[1]),
                t.parts.push((s[2] << 8) | s[3]),
          ...
          (h.subnetMatch = function (e, t, r) {
            ...
            for (n in (null == r && (r = "unicast"), t))
              if (Object.prototype.hasOwnProperty.call(t, n)) {
                for (
                  !(s = t[n])[0] || s[0] instanceof Array || (s = [s]), i = 0;
                  i < s.length;
                  i++
                )
                  if (
                    ((o = s[i]),
                    e.kind() === o[0].kind() && e.match.apply(e, o))
                  )
                    return n;
              }
            return r;
    ...
    29067: (e, t) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        ((i || (t.objectUtil = i = {})).mergeShapes = (e, t) => ({
          ...e,
          ...t,
        })),
    ...
    31168: (e, t, r) => {
      ...
      let f = (0, o.D0)(l, void 0, void 0, { sqrt: p }),
        g = (0, s.s)(
          {
            a: BigInt(0),
            b: BigInt(7),
      ...
      function C(e) {
        ...
        return { scalar: r.hasEvenY() ? t : k(-t), bytes: b(r) };
      }
      function I(e) {
        (0, a.aK)("x", e, c, l);
        let t = x(e * e),
        ...
        w = (function (e) {
          ...
          let C = (0, a.x)((e, t) => {
            ...
            I = (0, a.x)((e) => {
              ...
              let { ex: n, ey: s, ez: o, et: a } = e,
                l = v(n * n),
                u = v(s * s),
                c = v(o * o),
                d = v(c * c),
                h = v(l * r);
              if (v(c * v(h + u)) !== v(d + v(i * v(l * u))))
          ...
          class B {
            ...
            multiplyUnsafe(e, t = B.ZERO) {
              return (a.aK("scalar", e, l, i), e === l)
                ? _
                : this.is0() || e === u
                ? this
                : T.wNAFCachedUnsafe(this, e, B.normalizeZ, t);
            }
            isSmallOrder() {
          ...
          (B.BASE = new B(t.Gx, t.Gy, u, v(t.Gx * t.Gy))),
            (B.ZERO = new B(l, u, u, l));
          let { BASE: E, ZERO: _ } = B,
            T = (0, s.hT)(B, 8 * g);
          function N(e) {
            var t;
          ...
          function O(e) {
            ...
            let i = (0, a.qj)("hashed private key", p(e), 2 * t),
              ...
              l = E.multiply(o),
              u = l.toRawBytes();
            return { head: n, prefix: s, scalar: o, point: l, pointBytes: u };
          }
          ...
          return (
            E._setWindowSize(8),
            {
              ...
              sign: function (e, t, s = {}) {
                ...
                let { prefix: c, scalar: d, pointBytes: h } = O(t),
                  p = U(s.context, c, e),
                  f = E.multiply(p).toRawBytes(),
                  g = ((u = p + U(s.context, f, h, e) * d), (0, o.zi)(u, i));
              ...
              verify: function (e, t, i, s = h) {
                let o, l, u;
                let { context: c, zip215: d } = s,
                  p = r.BYTES;
                (e = (0, a.qj)("signature", e, 2 * p)),
                  (t = (0, a.qj)("message", t)),
                  (i = (0, a.qj)("publicKey", i, p)),
                  void 0 !== d && (0, a.e8)("zip215", d),
                  n && (t = n(t));
                let f = a.lX(e.slice(p, 2 * p));
                try {
                  (o = B.fromHex(i, d)),
                    (l = B.fromHex(e.slice(0, p), d)),
                    (u = E.multiplyUnsafe(f));
                } catch (e) {
                  return !1;
                }
            ...
            let r = (0, o.zi)(t * t * t, p),
              i = (function (e) {
                let t = BigInt(10),
                  ...
                  v = ((0, o.zH)(f, n, p) * h) % p,
                  b = ((0, o.zH)(v, t, p) * u) % p;
                return { pow_p_5_8: ((0, o.zH)(b, y, p) * e) % p, b2: s };
      ...
      class c {
        static toString(e, t = !1) {
          ...
          for (let e = 0; e < r.byteLength; e += 2)
            s += String.fromCharCode(i.getUint16(e, t));
          return s;
        }
    ...
    57238: function (e, t, r) {
      ...
      var n,
        ...
        u =
          ...
          function (e, t, r, i, n) {
            ...
            return (
              "a" === i ? n.call(e, r) : n ? (n.value = r) : t.set(e, r), r
            );
          };
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.boolean =
      ...
      let y = (e, t) => {
        if ((0, h.isValid)(t)) return { success: !0, data: t.value };
      ...
      class v {
        ...
        "~validate"(e) {
          ...
          return this._parseAsync({ data: e, path: [], parent: i }).then((e) =>
            (0, h.isValid)(e) ? { value: e.value } : { issues: i.common.issues }
          );
        }
        ...
        refine(e, t) {
          ...
          return this._refinement((t, i) => {
            let n = e(t),
              s = () => i.addIssue({ code: f.ZodIssueCode.custom, ...r(t) });
      ...
      class V extends v {
        _parse(e) {
          ...
          if (
            ...
            this._getType(e) !== p.ZodParsedType.string)
          ) {
        ...
        emoji(e) {
          return this._addCheck({ kind: "emoji", ...d.errorUtil.errToObj(e) });
        }
        uuid(e) {
          return this._addCheck({ kind: "uuid", ...d.errorUtil.errToObj(e) });
        }
        nanoid(e) {
          return this._addCheck({ kind: "nanoid", ...d.errorUtil.errToObj(e) });
        }
        cuid(e) {
          return this._addCheck({ kind: "cuid", ...d.errorUtil.errToObj(e) });
        }
        cuid2(e) {
          return this._addCheck({ kind: "cuid2", ...d.errorUtil.errToObj(e) });
        }
        ulid(e) {
          return this._addCheck({ kind: "ulid", ...d.errorUtil.errToObj(e) });
        }
        base64(e) {
          return this._addCheck({ kind: "base64", ...d.errorUtil.errToObj(e) });
        }
        base64url(e) {
        ...
        jwt(e) {
          return this._addCheck({ kind: "jwt", ...d.errorUtil.errToObj(e) });
        }
        ip(e) {
          return this._addCheck({ kind: "ip", ...d.errorUtil.errToObj(e) });
        }
        cidr(e) {
          return this._addCheck({ kind: "cidr", ...d.errorUtil.errToObj(e) });
        }
        datetime(e) {
          var t, r;
      ...
      class j extends v {
        ...
        _parse(e) {
          ...
          if (
            ...
            this._getType(e) !== p.ZodParsedType.number)
          ) {
            let t = this._getOrReturnCtx(e);
            return (
              (0, h.addIssueToContext)(t, {
        ...
        get isInt() {
          return !!this._def.checks.find(
            (e) =>
              "int" === e.kind ||
              ("multipleOf" === e.kind && p.util.isInteger(e.value))
          );
        }
        get isFinite() {
          let e = null,
      ...
      class R extends v {
        ...
        _parse(e) {
          ...
          if (this._getType(e) !== p.ZodParsedType.bigint)
            return this._getInvalidInput(e);
          let r = new h.ParseStatus();
          for (let i of this._def.checks)
            "min" === i.kind
      ...
      class D extends v {
        _parse(e) {
          if (
            ...
            this._getType(e) !== p.ZodParsedType.boolean)
          ) {
            let t = this._getOrReturnCtx(e);
            return (
              (0, h.addIssueToContext)(t, {
      ...
      class $ extends v {
        _parse(e) {
          ...
          if (
            ...
            this._getType(e) !== p.ZodParsedType.date)
          ) {
            let t = this._getOrReturnCtx(e);
            return (
              (0, h.addIssueToContext)(t, {
      ...
      (t.ZodSymbol = H),
        (H.create = (e) => new H({ typeName: a.ZodSymbol, ...m(e) }));
      class M extends v {
        _parse(e) {
      ...
      (t.ZodUndefined = M),
        (M.create = (e) => new M({ typeName: a.ZodUndefined, ...m(e) }));
      class F extends v {
        _parse(e) {
      ...
      (t.ZodNull = F),
        (F.create = (e) => new F({ typeName: a.ZodNull, ...m(e) }));
      class z extends v {
        constructor() {
      ...
      (t.ZodAny = z),
        (z.create = (e) => new z({ typeName: a.ZodAny, ...m(e) }));
      class W extends v {
        constructor() {
      ...
      (t.ZodNever = q),
        (q.create = (e) => new q({ typeName: a.ZodNever, ...m(e) }));
      class K extends v {
        _parse(e) {
          if (this._getType(e) !== p.ZodParsedType.undefined) {
            let t = this._getOrReturnCtx(e);
      ...
      (t.ZodVoid = K),
        (K.create = (e) => new K({ typeName: a.ZodVoid, ...m(e) }));
      class G extends v {
        _parse(e) {
          let { ctx: t, status: r } = this._processInputParams(e),
            i = this._def;
          if (t.parsedType !== p.ZodParsedType.array)
            return (
              (0, h.addIssueToContext)(t, {
                code: f.ZodIssueCode.invalid_type,
          ...
          if (
            ...
            return Promise.all(
              [...t.data].map((e, r) =>
                i.type._parseAsync(new g(t, e, t.path, r))
              )
            ).then((e) => h.ParseStatus.mergeArray(r, e));
          let n = [...t.data].map((e, r) =>
            i.type._parseSync(new g(t, e, t.path, r))
          );
        ...
        length(e, t) {
          return new G({
            ...this._def,
            exactLength: { value: e, message: d.errorUtil.toString(t) },
          });
        }
        nonempty(e) {
          return this.min(1, e);
      ...
      class Y extends v {
        ...
        _parse(e) {
          ...
          return r.common.async
            ? Promise.resolve()
                ...
                .then((e) => h.ParseStatus.mergeObjectSync(t, e))
            : h.ParseStatus.mergeObjectSync(t, o);
        }
        get shape() {
                ...
                ? {
                    errorMap: (t, r) => {
                      ...
                      return "unrecognized_keys" === t.code
                        ? {
                            message:
                              null !== (o = d.errorUtil.errToObj(e).message) &&
                              void 0 !== o
                                ? o
                                : a,
                          }
        ...
        omit(e) {
          let t = {};
          return (
            p.util.objectKeys(this.shape).forEach((r) => {
        ...
        deepPartial() {
          return (function e(t) {
            if (t instanceof Y) {
              ...
              return new Y({ ...t._def, shape: () => r });
            }
            if (t instanceof G) return new G({ ...t._def, type: e(t.element) });
      ...
      (t.ZodUnion = J),
        (J.create = (e, t) =>
          new J({ options: e, typeName: a.ZodUnion, ...m(t) }));
      let Q = (e) => {
      ...
      class X extends v {
        _parse(e) {
          let { ctx: t } = this._processInputParams(e);
          if (t.parsedType !== p.ZodParsedType.object)
            return (
              (0, h.addIssueToContext)(t, {
                code: f.ZodIssueCode.invalid_type,
                expected: p.ZodParsedType.object,
          ...
          let { status: t, ctx: r } = this._processInputParams(e),
            i = (e, i) => {
              ...
              let n = (function e(t, r) {
                ...
                if (
                  i === p.ZodParsedType.object &&
                  n === p.ZodParsedType.object
                ) {
                ...
                if (
                  i === p.ZodParsedType.array &&
                  n === p.ZodParsedType.array
                ) {
                ...
                if (
                  i === p.ZodParsedType.date &&
                  n === p.ZodParsedType.date &&
                  +t == +r
                )
              ...
              return n.valid
                ? (((0, h.isDirty)(e) || (0, h.isDirty)(i)) && t.dirty(),
      ...
      (t.ZodIntersection = ee),
        (ee.create = (e, t, r) =>
          new ee({ left: e, right: t, typeName: a.ZodIntersection, ...m(r) }));
      class et extends v {
        _parse(e) {
          let { status: t, ctx: r } = this._processInputParams(e);
          if (r.parsedType !== p.ZodParsedType.array)
            return (
              (0, h.addIssueToContext)(r, {
                code: f.ZodIssueCode.invalid_type,
                expected: p.ZodParsedType.array,
          ...
          let i = [...r.data]
            ...
            .filter((e) => !!e);
          return r.common.async
            ? Promise.all(i).then((e) => h.ParseStatus.mergeArray(t, e))
            : h.ParseStatus.mergeArray(t, i);
        }
        get items() {
          return this._def.items;
        }
        rest(e) {
          return new et({ ...this._def, rest: e });
        }
      }
      (t.ZodTuple = et),
        (et.create = (e, t) => {
      ...
      class er extends v {
        ...
        _parse(e) {
          let { status: t, ctx: r } = this._processInputParams(e);
          if (r.parsedType !== p.ZodParsedType.object)
            return (
              (0, h.addIssueToContext)(r, {
                code: f.ZodIssueCode.invalid_type,
                expected: p.ZodParsedType.object,
          ...
          return r.common.async
            ? h.ParseStatus.mergeObjectAsync(t, i)
            : h.ParseStatus.mergeObjectSync(t, i);
        }
        get element() {
          return this._def.valueType;
        }
      ...
      class ei extends v {
        ...
        _parse(e) {
          let { status: t, ctx: r } = this._processInputParams(e);
          if (r.parsedType !== p.ZodParsedType.map)
            return (
              (0, h.addIssueToContext)(r, {
                code: f.ZodIssueCode.invalid_type,
      ...
      (t.ZodMap = ei),
        (ei.create = (e, t, r) =>
          new ei({ valueType: t, keyType: e, typeName: a.ZodMap, ...m(r) }));
      class en extends v {
        _parse(e) {
          let { status: t, ctx: r } = this._processInputParams(e);
          if (r.parsedType !== p.ZodParsedType.set)
            return (
              (0, h.addIssueToContext)(r, {
                code: f.ZodIssueCode.invalid_type,
      ...
      class es extends v {
        ...
        _parse(e) {
          let { ctx: t } = this._processInputParams(e);
          if (t.parsedType !== p.ZodParsedType.function)
            return (
              (0, h.addIssueToContext)(t, {
                code: f.ZodIssueCode.invalid_type,
        ...
        args(...e) {
          return new es({ ...this._def, args: et.create(e).rest(W.create()) });
        }
        returns(e) {
      ...
      (t.ZodLazy = eo),
        (eo.create = (e, t) =>
          new eo({ getter: e, typeName: a.ZodLazy, ...m(t) }));
      class ea extends v {
        _parse(e) {
      ...
      function el(e, t) {
        return new eu({ values: e, typeName: a.ZodEnum, ...m(t) });
      }
      (t.ZodLiteral = ea),
        (ea.create = (e, t) =>
          new ea({ value: e, typeName: a.ZodLiteral, ...m(t) }));
      class eu extends v {
        constructor() {
        ...
        _parse(e) {
          ...
          if (
            (l(this, s, "f") || u(this, s, new Set(this._def.values), "f"),
            !l(this, s, "f").has(e.data))
          ) {
            let t = this._getOrReturnCtx(e),
              r = this._def.values;
            return (
        ...
        extract(e, t = this._def) {
          return eu.create(e, { ...this._def, ...t });
        }
      ...
      class ec extends v {
        ...
        _parse(e) {
          ...
          if (
            r.parsedType !== p.ZodParsedType.string &&
            r.parsedType !== p.ZodParsedType.number
          ) {
          ...
          if (
            (l(this, o, "f") ||
              u(
                this,
                o,
                new Set(p.util.getValidEnumValues(this._def.values)),
                "f"
              ),
            !l(this, o, "f").has(e.data))
          ) {
            let e = p.util.objectValues(t);
            return (
              (0, h.addIssueToContext)(r, {
      ...
      (t.ZodNativeEnum = ec),
        (o = new WeakMap()),
        (ec.create = (e, t) =>
          new ec({ values: e, typeName: a.ZodNativeEnum, ...m(t) }));
      class ed extends v {
        unwrap() {
          return this._def.type;
        }
        _parse(e) {
          let { ctx: t } = this._processInputParams(e);
          if (t.parsedType !== p.ZodParsedType.promise && !1 === t.common.async)
            return (
              (0, h.addIssueToContext)(t, {
                code: f.ZodIssueCode.invalid_type,
          ...
          let r =
            t.parsedType === p.ZodParsedType.promise
              ? t.data
      ...
      (t.ZodPromise = ed),
        (ed.create = (e, t) =>
          new ed({ type: e, typeName: a.ZodPromise, ...m(t) }));
      class eh extends v {
        innerType() {
      ...
      (t.ZodEffects = eh),
        (t.ZodTransformer = eh),
        (eh.create = (e, t, r) =>
          new eh({ schema: e, typeName: a.ZodEffects, effect: t, ...m(r) })),
      ...
      class ep extends v {
        _parse(e) {
          return this._getType(e) === p.ZodParsedType.undefined
            ? (0, h.OK)(void 0)
      ...
      (t.ZodOptional = ep),
        (ep.create = (e, t) =>
          new ep({ innerType: e, typeName: a.ZodOptional, ...m(t) }));
      class ef extends v {
        _parse(e) {
          return this._getType(e) === p.ZodParsedType.null
            ? (0, h.OK)(null)
            : this._def.innerType._parse(e);
        }
        unwrap() {
      ...
      (t.ZodNullable = ef),
        (ef.create = (e, t) =>
          new ef({ innerType: e, typeName: a.ZodNullable, ...m(t) }));
      class eg extends v {
        _parse(e) {
          let { ctx: t } = this._processInputParams(e),
            r = t.data;
          return (
            t.parsedType === p.ZodParsedType.undefined &&
      ...
      (t.ZodNaN = em),
        (em.create = (e) => new em({ typeName: a.ZodNaN, ...m(e) })),
      ...
      class eb extends v {
        ...
        static create(e, t) {
          return new eb({ in: e, out: t, typeName: a.ZodPipeline });
        }
      }
      t.ZodPipeline = eb;
      class ew extends v {
        _parse(e) {
          let t = this._def.innerType._parse(e),
            r = (e) => (
              (0, h.isValid)(e) && (e.value = Object.freeze(e.value)), e
            );
      ...
      (t.ZodReadonly = ew),
        (ew.create = (e, t) =>
          new ew({ innerType: e, typeName: a.ZodReadonly, ...m(t) })),
        (t.custom = ek),
        (t.late = { object: Y.lazycreate }),
        ((n = a || (t.ZodFirstPartyTypeKind = a = {})).ZodString = "ZodString"),
      ...
      (t.boolean = eC),
        ...
        (t.array = G.create),
        (t.object = Y.create),
        (t.strictObject = Y.strictCreate),
        (t.union = J.create),
        (t.discriminatedUnion = X.create),
        (t.intersection = ee.create),
        (t.tuple = et.create),
        (t.record = er.create),
        (t.map = ei.create),
        (t.set = en.create),
        (t.function = es.create),
        (t.lazy = eo.create),
        (t.literal = ea.create),
        (t.enum = eu.create),
        (t.nativeEnum = ec.create),
        (t.promise = ed.create);
      let eI = eh.create;
      (t.effect = eI),
        (t.transformer = eI),
        (t.optional = ep.create),
        (t.nullable = ef.create),
        (t.preprocess = eh.createWithPreprocess),
        (t.pipeline = eb.create),
        (t.ostring = () => eA().optional()),
        (t.onumber = () => eS().optional()),
        (t.oboolean = () => eC().optional()),
        (t.coerce = {
    ...
    75958: (e, t) => {
      ...
      function l(e, t, r) {
        ...
        for (
          ...
          for (let n = i; n < s.length; n++) {
            ...
            if (((s[n] = u), !Number.isSafeInteger(u) || u * r + e !== l))
              throw Error("convertRadix: carry overflow");
            o && (u ? (o = !1) : (i = n));
          }
          if ((n.push(e), o)) break;
      ...
      function d(e, t, r, i) {
        ...
        if (c(t, r) > 32)
          throw Error(
            `convertRadix2: carry overflow from=${t} to=${r} carryBits=${c(
              t,
              r
            )}`
          );
      ...
      function h(e) {
        return {
          ...
          decode: (t) => {
            if (!Array.isArray(t) || (t.length && "number" != typeof t[0]))
              throw Error("radix.decode input should be array of numbers");
        ...
        return {
          ...
          decode: (r) => {
            if (!Array.isArray(r) || (r.length && "number" != typeof r[0]))
              throw Error("radix2.decode input should be array of numbers");
      ...
      (t.utils = {
        ...
        (t.base16 = i(p(4), n("0123456789ABCDEF"), s(""))),
        (t.base32 = i(
          p(5),
        ...
        (t.base32nopad = i(p(5), n("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), s(""))),
        (t.base32hex = i(
          p(5),
        ...
        (t.base32crockford = i(
          ...
          s(""),
          a((e) => e.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1"))
        )),
        (t.base64 = i(
          p(6),
      ...
      (t.base58xmr = {
        ...
        (t.createBase58check = (e) =>
          i(
            g(4, (t) => e(e(t))),
            t.base58
          )),
        (t.base58check = t.createBase58check);
      ...
      function k(e) {
        ...
        function o(e, r, i = 90) {
          ...
          if (0 === e.length)
            throw TypeError(`Invalid prefix length ${e.length}`);
          let n = e.length + 7 + r.length;
          if (!1 !== i && n > i)
            throw TypeError(`Length ${n} exceeds limit ${i}`);
          let s = e.toLowerCase(),
            a = x(s, r, t);
        ...
        function a(e, r = 90) {
          ...
          let l = v.decode(o).slice(0, -6),
            u = x(s, l, t);
          if (!o.endsWith(u))
            throw Error(`Invalid checksum in ${e}: expected "${u}"`);
          return { prefix: s, words: l };
        }
        let l = f(a);
        return {
          encode: o,
      ...
      (t.bytesToString = (e, t) => {
        ...
        (t.stringToBytes = (e, t) => {
          ...
          if ("string" != typeof t)
            throw TypeError("stringToBytes() expects string");
          return A[e].decode(t);
        }),
    ...
    82177: (e, t, r) => {
      ...
      (Q.toArrayBuffer = (e, t) => {
        ...
        for (n = 0; n < r; n += 4)
          (o = h[e.charCodeAt(n)]),
            (a = h[e.charCodeAt(n + 1)]),
            (l = h[e.charCodeAt(n + 2)]),
            (u = h[e.charCodeAt(n + 3)]),
            (d[s++] = (o << 2) | (a >> 4)),
            (d[s++] = ((15 & a) << 4) | (l >> 2)),
            (d[s++] = ((3 & l) << 6) | (63 & u));
        return c;
        ...
        (Q.fromArrayBuffer = (e, t) => {
          ...
          for (i = 0; i < s; i += 3)
            (n += o[r[i] >> 2]),
              (n += o[((3 & r[i]) << 4) | (r[i + 1] >> 4)]),
              (n += o[((15 & r[i + 1]) << 2) | (r[i + 2] >> 6)]),
              (n += o[63 & r[i + 2]]);
          let a = s % 3;
          return (
            2 === a
              ? (n = n.substring(0, n.length - 1) + (t ? "" : "="))
              : 1 === a && (n = n.substring(0, n.length - 2) + (t ? "" : "==")),
            n
          );
        }),
        (Q.toString = (e, t) =>
          new TextDecoder().decode(Q.toArrayBuffer(e, t))),
        (Q.fromString = (e, t) =>
          Q.fromArrayBuffer(new TextEncoder().encode(e), t)),
        (Q.validate = (e, t) => {
        ...
        return (
          ((t = class extends e {
            constructor(...e) {
              ...
              let r = e[0] || {};
              (this.isHexOnly =
                null !== (t = r.isHexOnly) && void 0 !== t && t),
                (this.valueHexView = r.valueHex
                  ? ee._H.toUint8Array(r.valueHex)
                  : eg);
            }
            get valueHex() {
            ...
            toBER(e = !1) {
              return this.isHexOnly
                ...
                : ((this.error = "Flag 'isHexOnly' is not set, abort"), ef);
            }
            toJSON() {
              return {
                ...super.toJSON(),
      ...
      class ew {
        constructor({
          ...
          (this.blockLength = e),
            (this.error = t),
            (this.warnings = r),
            (this.valueBeforeDecodeView = ee._H.toUint8Array(i));
        }
        static blockName() {
          return this.NAME;
        }
          ...
          super(),
            e
              ? ((this.isHexOnly =
                ...
                (this.isConstructed =
                  null !== (n = e.isConstructed) && void 0 !== n && n))
              : ((this.tagClass = -1),
                (this.tagNumber = -1),
      ...
      class eC extends ew {
        constructor(
          ...
          super(i),
            ...
            (this.idBlock = new ek(i)),
            (this.lenBlock = new eA(i)),
            (this.valueBlock = n ? new n(i) : new ex(i));
        }
        fromBER(e, t, r) {
        ...
        toString(e = "ascii") {
          return "ascii" === e
            ...
            : ee.U$.ToHex(this.toBER());
        }
        onAsciiEncoding() {
          return `${this.constructor.NAME} : ${ee.U$.ToHex(
      ...
      function e_(e, t = 0, r = e.length) {
        let i = t,
          ...
          s = new ew();
        if (!el(s, e, t, r))
          return (n.error = s.error), { offset: -1, result: n };
      ...
      class eN extends ex {
        ...
        fromBER(e, t, r) {
          ...
          if (
            ((this.valueBeforeDecodeView = s.subarray(t, t + r)),
          ...
          for (; (i = this.isIndefiniteForm), (n = r), (i ? 1 : n) > 0; ) {
            ...
            if (
              ...
              this.isIndefiniteForm && e.result.constructor.NAME === ey)
            )
              break;
          }
          return (
            this.isIndefiniteForm &&
              (this.value[this.value.length - 1].constructor.NAME === ey
                ? this.value.pop()
...
${e.join("\n")}`
      ...
      class eL extends eb(ex) {
        constructor({ value: e, ...t } = {}) {
          super(t),
            t.valueHex
              ? (this.valueHexView = ee._H.toUint8Array(t.valueHex))
      ...
      class ej extends eb(eN) {
        ...
        fromBER(e, t, r) {
          ...
          if (this.isConstructed) {
            if (
              ((this.isHexOnly = !1),
              -1 === (i = eN.prototype.fromBER.call(this, e, t, r)))
            )
              return i;
        ...
        toBER(e, t) {
          return this.isConstructed
            ? eN.prototype.toBER.call(this, e, t)
            : e
            ? new ArrayBuffer(this.valueHexView.byteLength)
            : this.valueHexView.slice().buffer;
        }
      ...
      class eR extends eC {
        constructor({ idBlock: e = {}, lenBlock: t = {}, ...r } = {}) {
          ...
          (null !== (i = r.isConstructed) && void 0 !== i) ||
            (r.isConstructed = !!(null === (n = r.value) || void 0 === n
              ? void 0
              : n.length)),
            super(
              {
        ...
        onAsciiEncoding() {
          return this.valueBlock.isConstructed ||
            ...
            ? eO.prototype.onAsciiEncoding.call(this)
            : `${this.constructor.NAME} : ${ee.U$.ToHex(
        ...
        getValue() {
          ...
          let e = [];
          for (let t of this.valueBlock.value)
            t instanceof eR && e.push(t.valueBlock.valueHexView);
      ...
      class eD extends eb(eN) {
        ...
        fromBER(e, t, r) {
          ...
          if (((this.unusedBits = s[0]), this.unusedBits > 7))
            return (
        ...
        toBER(e, t) {
          ...
          return (
            (r[0] = this.unusedBits), r.set(this.valueHexView, 1), r.buffer
          );
        }
        toJSON() {
          return {
      ...
      class e$ extends eC {
        ...
        onAsciiEncoding() {
          if (
            ...
            return eO.prototype.onAsciiEncoding.call(this);
          {
            let e = [];
      ...
      class eM extends eb(ex) {
        ...
        setValueHex() {
          this.valueHexView.length >= 4
            ? (this.warnings.push("Too big Integer for decoding, hex only"),
              ...
              (this._valueDec = 0))
            : ((this.isHexOnly = !1),
              this.valueHexView.length > 0 && (this._valueDec = en.call(this)));
        }
        set valueDec(e) {
          (this._valueDec = e),
            (this.isHexOnly = !1),
                  ...
                  if (t <= r) {
                    ...
                    if (128 & s[0]) {
                      let e = n.slice(0),
                        t = new Uint8Array(e);
                      s = new Uint8Array(
                        (n = new ArrayBuffer(n.byteLength + 1))
                      );
          ...
          return (
            0 === s[0] && (128 & s[1]) != 0
              ...
              : 0 !== i &&
                ...
                (this.valueHexView = s.subarray(i - s.length))),
            n
          );
        }
        toDER(e = !1) {
        ...
        toString() {
                      ...
                      for (let e = c; e >= 0; e--, d++)
                        (u =
                          !0 == d < a.length
                            ? s[o - d] + a[l - d] + r[0]
                            : s[o - d] + r[0]),
                          ((r[0] = u / 10), !0 == d >= s.length)
                            ? (s = ei(new Uint8Array([u % 10]), s))
                            : (s[o - d] = u % 10);
          ...
          for (let e = 0; e < r.length; e++)
            r[e] && (o = !0), o && (s += ed.charAt(r[e]));
          return !1 === o && (s += ed.charAt(0)), s;
        }
      }
      (eM.NAME = "IntegerValueBlock"),
        Object.defineProperty(eM.prototype, "valueHex", {
          set: function (e) {
      ...
      class eF extends eC {
        ...
        static fromBigInt(e) {
          ...
          return new eF({ valueHex: r.final() });
        }
        convertToDER() {
          let e = new eF({ valueHex: this.valueBlock.valueHexView });
      ...
      class eW extends eb(ex) {
        ...
        fromBER(e, t, r) {
          ...
          for (let e = 0; e < this.blockLength; e++)
            s[e] = this.valueHexView[e];
          return ((this.valueHexView = s), (128 & n[this.blockLength - 1]) != 0)
            ? ((this.error =
                "End of input reached before message was fully decoded"),
              -1)
            : (0 === this.valueHexView[0] &&
              ...
              this.blockLength <= 8
                ? (this.valueDec = et(this.valueHexView, 7))
                : ((this.isHexOnly = !0),
        ...
        toBER(e) {
          if (this.isHexOnly) {
            ...
            return (
              (r[this.blockLength - 1] = t[this.blockLength - 1]), r.buffer
            );
          }
          let t = er(this.valueDec, 7);
          if (0 === t.byteLength)
            return (this.error = "Error during encoding SID value"), ef;
      ...
      class eq extends ex {
        ...
        toBER(e) {
          ...
          for (let r = 0; r < this.value.length; r++) {
            ...
            if (0 === i.byteLength)
              return (this.error = this.value[r].error), ef;
            t.push(i);
          }
          return ea(t);
        }
      ...
      class eY extends ex {
        ...
        toBER(e, t) {
          ...
          for (let t = 0; t < this.value.length; t++) {
            ...
            if (0 === i.byteLength)
              return (this.error = this.value[t].error), ef;
            r.push(i);
          }
          return ea(r);
        }
      ...
      (eS.RelativeObjectIdentifier = eJ),
        (eJ.NAME = "RelativeObjectIdentifier");
      class eQ extends eO {
        constructor(e = {}) {
        ...
        fromBuffer(e) {
          ...
          try {
            ...
            this.warnings.push(
              ...
              (this.valueBlock.value = ee.U$.ToBinary(e));
          }
        }
        fromString(e) {
          (this.valueBlock.valueHexView = new Uint8Array(
            ee.U$.FromUtf8String(e)
          )),
            (this.valueBlock.value = e);
        }
      }
      ...
      class e4 extends e2 {
        fromBuffer(e) {
          (this.valueBlock.value = ee.U$.ToUtf16String(e)),
            (this.valueBlock.valueHexView = ee._H.toUint8Array(e));
        }
        fromString(e) {
          (this.valueBlock.value = e),
            (this.valueBlock.valueHexView = new Uint8Array(
              ee.U$.FromUtf16String(e)
            ));
        }
      }
      ...
      class tl extends ts {
        ...
        fromBuffer(e) {
          this.fromString(
            String.fromCharCode.apply(null, ee._H.toUint8Array(e))
          );
        }
        toBuffer() {
          let e = this.toString(),
        ...
        toString(e = "iso") {
          if ("iso" === e) {
            ...
            return (
              ...
              (e[2] = es(this.day, 2)),
              (e[3] = es(this.hour, 2)),
              (e[4] = es(this.minute, 2)),
              (e[5] = es(this.second, 2)),
              (e[6] = "Z"),
              e.join("")
            );
          }
      ...
      class tu extends tl {
        ...
        toString(e = "iso") {
          if ("iso" === e) {
            let e = [];
            return (
              e.push(es(this.year, 4)),
              e.push(es(this.month, 2)),
              e.push(es(this.day, 2)),
              e.push(es(this.hour, 2)),
              e.push(es(this.minute, 2)),
              e.push(es(this.second, 2)),
              0 !== this.millisecond &&
                (e.push("."), e.push(es(this.millisecond, 3))),
              e.push("Z"),
              e.join("")
            );
          }
      ...
      class tm extends tg {
        constructor({ value: e = new tg(), local: t = !1, ...r } = {}) {
          super(r), (this.value = e), (this.local = t);
        }
      }
      class tv {
        constructor({ data: e = eg } = {}) {
      ...
      function tb(e, t, r) {
        ...
        if (r instanceof tg)
          return (
            r.hasOwnProperty(eh) && (e[r.name] = t), { verified: !0, result: e }
          );
        ...
        if (
          ...
          if (
            (s > 0 &&
              r.valueBlock.value[0] instanceof tm &&
          ...
          for (let o = 0; o < s; o++)
            if (o - i >= t.valueBlock.value.length) {
              ...
              if (
                !1 ===
                (n = tb(e, t.valueBlock.value[o], r.valueBlock.value[0].value))
                  .verified
              ) {
              ...
              if (
                ...
                void 0 ===
                  ...
                  i[r.valueBlock.value[0].name].push(t.valueBlock.value[o]);
              }
            } else if (
              !1 ===
              (n = tb(e, t.valueBlock.value[o - i], r.valueBlock.value[o]))
                .verified
            ) {
      ...
      class tx {
        constructor(e, t = 0) {
          if (((this.unusedBits = 0), (this.value = new ArrayBuffer(0)), e)) {
            ...
            else if (ee._H.isBufferSource(e))
              (this.unusedBits = t), (this.value = ee._H.toArrayBuffer(e));
            else
              throw TypeError(
        ...
        toASN() {
          return new e$({ unusedBits: this.unusedBits, valueHex: this.value });
        }
        toSchema(e) {
          return new e$({ name: e });
        }
      ...
      class tk {
        ...
        constructor(e) {
          "number" == typeof e
            ...
            : ee._H.isBufferSource(e)
            ? (this.buffer = ee._H.toArrayBuffer(e))
            : Array.isArray(e)
        ...
        toASN() {
          return new eR({ valueHex: this.buffer });
        }
        toSchema(e) {
          return new eR({ name: e });
        }
      }
      let tA = {
        ...
        tS = {
          ...
          toASN: (e) => new eF({ value: +e }),
        },
        tC = {
          fromASN: (e) => e.valueBlock.valueDec,
          toASN: (e) => new ez({ value: e }),
        },
        tI = {
          fromASN: (e) => e.valueBlock.valueHexView,
          toASN: (e) => new eF({ valueHex: e }),
        },
        tB = {
          fromASN: (e) => e.valueBlock.valueHexView,
          toASN: (e) => new e$({ valueHex: e }),
        },
        tE = {
          fromASN: (e) => e.valueBlock.toString(),
          toASN: (e) => new eK({ value: e }),
        },
        t_ = {
          fromASN: (e) => e.valueBlock.value,
          toASN: (e) => new eV({ value: e }),
        },
        tT = {
          fromASN: (e) => e.valueBlock.valueHexView,
          toASN: (e) => new eR({ valueHex: e }),
        };
      function tN(e) {
        return {
          fromASN: (e) => e.valueBlock.value,
      ...
      let tO = tN(e8),
        ...
        tF = {
          fromASN: (e) => e.toDate(),
          toASN: (e) => new tl({ valueDate: e }),
        },
        tz = {
          fromASN: (e) => e.toDate(),
          toASN: (e) => new tu({ valueDate: e }),
        },
        tW = { fromASN: () => null, toASN: () => new eZ() };
      function tq(e) {
        switch (e) {
          case n.Any:
            return tA;
      ...
      function tK(e) {
        return "function" == typeof e && e.prototype
          ? (!!e.prototype.toASN && !!e.prototype.fromASN) || tK(e.prototype)
        ...
        create(e, t) {
          ...
          for (let e in r.items) {
            ...
            if ("number" == typeof a.type) {
              ...
              tK(a.type)
                ? (o = new a.type().toSchema(l))
                : a.optional
                ? this.get(a.type).type === i.Choice
                  ? (o = new tg({ name: l }))
                  : ((o = this.create(a.type, !1)).name = l)
                : (o = new tg({ name: l }));
            let u = !!a.optional || void 0 !== a.defaultValue;
            if (
              (a.repeated &&
                ((o.name = ""),
                (o = new ("set" === a.repeated ? eX : eQ)({
                  name: "",
                  value: [new tm({ name: l, value: o })],
                }))),
          ...
          switch (r.type) {
            case i.Sequence:
              return new eQ({ value: s, name: "" });
            case i.Set:
              return new eX({ value: s, name: "" });
            case i.Choice:
              return new ty({ value: s, name: "" });
            default:
      ...
      let tY = new tG(),
        tJ = (e) => (t) => {
          ...
          tY.has(t)
            ? (r = tY.get(t))
            : ((r = tY.createDefault(t)), tY.set(t, r)),
            Object.assign(r, e);
        },
        tQ = (e) => (t, r) => {
          let i;
          tY.has(t.constructor)
            ? (i = tY.get(t.constructor))
            : ((i = tY.createDefault(t.constructor)), tY.set(t.constructor, i));
      ...
      class t0 {
        ...
        static fromASN(e, t) {
          ...
          try {
            ...
            if (!a.verified)
              throw new tX(
                `Data does not match to ${t.name} ASN1 schema. ${a.result.error}`
              );
            let l = new t();
            if (
              (function e(t) {
              ...
              if (
                !("value" in e.valueBlock && Array.isArray(e.valueBlock.value))
              )
                throw Error(
              ...
              if ("number" == typeof o || tK(o)) {
                ...
                if (i.repeated) {
                  if (i.implicit) {
                    ...
                    if (-1 === n.offset)
                      throw Error(
                        `Cannot parse the child item. ${n.result.error}`
                      );
                    if (
                      !(
        ...
        static toASN(e) {
          ...
          if (n.itemType) {
            ...
            if ("number" == typeof n.itemType) {
              ...
              s = e.map((e) =>
                this.toAsnItem({ type: n.itemType }, "[]", r, e)
              );
          } else
            for (let t in n.items) {
                ...
                ("object" == typeof i.defaultValue &&
                  ...
                  (function (e, t) {
                    ...
                    for (let t = 0; t < e.byteLength; t++)
                      if (r[t] !== i[t]) return !1;
                    return !0;
                  })(this.serialize(i.defaultValue), this.serialize(o)))
              )
                continue;
              ...
              if ("number" == typeof i.context) {
                if (i.implicit) {
                  if (
                    !i.repeated &&
                    ("number" == typeof i.type || tK(i.type))
                  ) {
                    let e = {};
                    (e.valueHex =
                      a instanceof eZ
        ...
        static toAsnItem(e, t, r, i) {
          ...
          if ("number" == typeof e.type) {
            ...
            if (e.repeated) {
              ...
              s = new ("sequence" === e.repeated ? eQ : eX)({ value: t });
            } else s = o.toASN(i);
          } else if (e.repeated) {
            if (!Array.isArray(i))
              throw TypeError("Parameter 'objProp' should be type of Array.");
      ...
      class t2 extends Array {
        constructor(e = []) {
          ...
          else for (let t of (super(), e)) this.push(t);
        }
      }
      class t6 {
        static serialize(e) {
        ...
        static toString(e) {
          let t = eT(
            ee._H.isBufferSource(e) ? ee._H.toArrayBuffer(e) : t6.serialize(e)
          );
          if (-1 === t.offset)
      ...
      (0, t8.Cg)(
        [tQ({ type: n.TeletexString })],
        t3.prototype,
        "teletexString",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: n.PrintableString })],
          t3.prototype,
          "printableString",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.UniversalString })],
          t3.prototype,
          "universalString",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.Utf8String })],
          t3.prototype,
          "utf8String",
          void 0
        ),
        ...
        (t3 = (0, t8.Cg)([tJ({ type: i.Choice })], t3));
      let t9 = class extends t3 {
        ...
        toString() {
          return (
            this.ia5String ||
            (this.anyValue ? ee.U$.ToHex(this.anyValue) : super.toString())
          );
        }
      };
      (0, t8.Cg)(
        ...
        (0, t8.Cg)([tQ({ type: n.Any })], t9.prototype, "anyValue", void 0),
        (t9 = (0, t8.Cg)([tJ({ type: i.Choice })], t9));
      class t7 {
        constructor(e = {}) {
      ...
      (0, t8.Cg)(
        [tQ({ type: t3, optional: !0, context: 0, implicit: !0 })],
        rn.prototype,
        "nameAssigner",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: t3, context: 1, implicit: !0 })],
          rn.prototype,
          "partyName",
          void 0
        );
      ...
      (0, t8.Cg)(
        [tQ({ type: ri, context: 0, implicit: !0 })],
        rs.prototype,
        "otherName",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: n.IA5String, context: 1, implicit: !0 })],
          rs.prototype,
          "rfc822Name",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.IA5String, context: 2, implicit: !0 })],
          rs.prototype,
          "dNSName",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.Any, context: 3, implicit: !0 })],
          rs.prototype,
          "x400Address",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: rr, context: 4, implicit: !1 })],
          rs.prototype,
          "directoryName",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: rn, context: 5 })],
          rs.prototype,
          "ediPartyName",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.IA5String, context: 6, implicit: !0 })],
          rs.prototype,
        ...
        (0, t8.Cg)(
          [tQ({ type: n.ObjectIdentifier, context: 8, implicit: !0 })],
          rs.prototype,
          "registeredID",
          void 0
        ),
        (rs = (0, t8.Cg)([tJ({ type: i.Choice })], rs));
      class ro {
        constructor(e = {}) {
          (this.accessMethod = ""),
      ...
      (0, t8.Cg)(
        ...
        (0, t8.Cg)([tQ({ type: rs })], ro.prototype, "accessLocation", void 0);
      let ra = (l = class extends t2 {
        constructor(e) {
          super(e), Object.setPrototypeOf(this, l.prototype);
        }
      });
      ra = l = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: ro })], ra);
      class rl extends tk {}
      class ru {
        constructor(e = {}) {
      ...
      (0, t8.Cg)(
        [tQ({ type: rl, context: 0, optional: !0, implicit: !0 })],
        ru.prototype,
        "keyIdentifier",
        void 0
      ),
      ...
      (0, t8.Cg)(
        [tQ({ type: n.Boolean, defaultValue: !1 })],
        rc.prototype,
        "cA",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: n.Integer, optional: !0 })],
          rc.prototype,
          "pathLenConstraint",
          void 0
        );
      ...
      rd = u = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: rs })], rd);
      let rh = (c = class extends rd {
        constructor(e) {
          super(e), Object.setPrototypeOf(this, c.prototype);
        }
      });
      rh = c = (0, t8.Cg)([tJ({ type: i.Sequence })], rh);
      let rp = class {
        constructor(e = {}) {
          Object.assign(this, e);
        }
      ...
      (0, t8.Cg)(
        ...
        (rp = (0, t8.Cg)([tJ({ type: i.Choice })], rp));
      class rf {
        constructor(e = {}) {
          (this.organization = new rp()),
            (this.noticeNumbers = []),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)([tQ({ type: rp })], rf.prototype, "organization", void 0),
        (0, t8.Cg)(
          [tQ({ type: n.Integer, repeated: "sequence" })],
          rf.prototype,
          "noticeNumbers",
          void 0
        );
      ...
      (0, t8.Cg)(
        [tQ({ type: rf, optional: !0 })],
        rg.prototype,
        "noticeRef",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: rp, optional: !0 })],
          rg.prototype,
          "explicitText",
          void 0
        );
      ...
      (0, t8.Cg)([tQ({ type: n.IA5String })], ry.prototype, "cPSuri", void 0),
        (0, t8.Cg)([tQ({ type: rg })], ry.prototype, "userNotice", void 0),
        (ry = (0, t8.Cg)([tJ({ type: i.Choice })], ry));
      class rm {
        constructor(e = {}) {
      ...
      (0, t8.Cg)(
        ...
        (0, t8.Cg)([tQ({ type: n.Any })], rm.prototype, "qualifier", void 0);
      class rv {
        constructor(e = {}) {
      ...
      (0, t8.Cg)(
        ...
        (0, t8.Cg)(
          [tQ({ type: rm, repeated: "sequence", optional: !0 })],
          rv.prototype,
          "policyQualifiers",
          void 0
        );
      ...
      rb = d = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: rv })], rb);
      let rw = class {
        constructor(e = 0) {
          this.value = e;
        }
      };
      (0, t8.Cg)([tQ({ type: n.Integer })], rw.prototype, "value", void 0),
        (rw = (0, t8.Cg)([tJ({ type: i.Choice })], rw));
      let rx = class extends rw {};
      (rx = (0, t8.Cg)([tJ({ type: i.Choice })], rx)),
        (function (e) {
          (e[(e.unused = 1)] = "unused"),
      ...
      class rk extends tx {
        toJSON() {
          let e = [],
            t = this.toNumber();
          return (
            t & p.aACompromise && e.push("aACompromise"),
            t & p.affiliationChanged && e.push("affiliationChanged"),
            t & p.cACompromise && e.push("cACompromise"),
            t & p.certificateHold && e.push("certificateHold"),
            t & p.cessationOfOperation && e.push("cessationOfOperation"),
            t & p.keyCompromise && e.push("keyCompromise"),
            t & p.privilegeWithdrawn && e.push("privilegeWithdrawn"),
            t & p.superseded && e.push("superseded"),
            t & p.unused && e.push("unused"),
            e
          );
        }
        toString() {
      ...
      (0, t8.Cg)(
        [tQ({ type: rs, context: 0, repeated: "sequence", implicit: !0 })],
        rA.prototype,
        "fullName",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: re, context: 1, implicit: !0 })],
          rA.prototype,
          "nameRelativeToCRLIssuer",
          void 0
        ),
        (rA = (0, t8.Cg)([tJ({ type: i.Choice })], rA));
      class rS {
        constructor(e = {}) {
          Object.assign(this, e);
        }
      ...
      (0, t8.Cg)(
        [tQ({ type: rA, context: 0, optional: !0 })],
        rS.prototype,
        "distributionPoint",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: rk, context: 1, optional: !0, implicit: !0 })],
          rS.prototype,
          "reasons",
          void 0
        ),
      ...
      rC = h = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: rS })], rC);
      let rI = (f = class extends rC {
        constructor(e) {
          super(e), Object.setPrototypeOf(this, f.prototype);
        }
      });
      rI = f = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: rS })], rI);
      class rB {
        constructor(e = {}) {
          (this.onlyContainsUserCerts = rB.ONLY),
            (this.onlyContainsCACerts = rB.ONLY),
            (this.indirectCRL = rB.ONLY),
            (this.onlyContainsAttributeCerts = rB.ONLY),
            Object.assign(this, e);
        }
      }
      (rB.ONLY = !1),
        ...
        (0, t8.Cg)(
          [tQ({ type: rk, context: 3, optional: !0, implicit: !0 })],
          rB.prototype,
          "onlySomeReasons",
          void 0
        ),
      ...
      (0, t8.Cg)([tQ({ type: n.Enumerated })], rE.prototype, "reason", void 0),
        (rE = (0, t8.Cg)([tJ({ type: i.Choice })], rE));
      ...
      r_ = y = (0, t8.Cg)(
        [tJ({ type: i.Sequence, itemType: n.ObjectIdentifier })],
        r_
      );
      let rT = class {
      ...
      (0, t8.Cg)(
        [tQ({ type: n.Integer, converter: tI })],
        rT.prototype,
        "value",
        void 0
      ),
        (rT = (0, t8.Cg)([tJ({ type: i.Choice })], rT));
      let rN = class {
        constructor(e) {
      ...
      (0, t8.Cg)(
        [tQ({ type: n.GeneralizedTime })],
        rN.prototype,
        "value",
        void 0
      ),
        (rN = (0, t8.Cg)([tJ({ type: i.Choice })], rN));
      let rO = (m = class extends rd {
        constructor(e) {
          super(e), Object.setPrototypeOf(this, m.prototype);
        }
      });
      (rO = m = (0, t8.Cg)([tJ({ type: i.Sequence })], rO)),
        (function (e) {
      ...
      (0, t8.Cg)([tQ({ type: rs })], rU.prototype, "base", void 0),
        (0, t8.Cg)(
          [tQ({ type: n.Integer, context: 0, defaultValue: 0, implicit: !0 })],
          rU.prototype,
          "minimum",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.Integer, context: 1, optional: !0, implicit: !0 })],
          rU.prototype,
          "maximum",
          void 0
        );
      ...
      rP = b = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: rU })], rP);
      class rZ {
        constructor(e = {}) {
          Object.assign(this, e);
        }
      ...
      (0, t8.Cg)(
        [tQ({ type: rP, context: 0, optional: !0, implicit: !0 })],
        rZ.prototype,
        "permittedSubtrees",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: rP, context: 1, optional: !0, implicit: !0 })],
          rZ.prototype,
          "excludedSubtrees",
          void 0
        );
      ...
      rj = w = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: rV })], rj);
      let rR = (x = class extends rd {
        constructor(e) {
          super(e), Object.setPrototypeOf(this, x.prototype);
        }
      });
      rR = x = (0, t8.Cg)([tJ({ type: i.Sequence })], rR);
      class rD {
        constructor(e = {}) {
      ...
      r$ = k = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: rD })], r$);
      class rH {
        constructor(e = {}) {
          Object.assign(this, e);
        }
      ...
      class rM extends tx {
        toJSON() {
          let e = [],
            t = this.toNumber();
          return (
            t & A.pKIXCertificate && e.push("pKIXCertificate"),
            t & A.newExtensions && e.push("newExtensions"),
            t & A.keyUpdateAllowed && e.push("keyUpdateAllowed"),
            e
          );
        }
        toString() {
      ...
      class rF {
        constructor(e = {}) {
          (this.entrustVers = ""),
            (this.entrustInfoFlags = new rM()),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)(
        [tQ({ type: n.GeneralString })],
        rF.prototype,
        "entrustVers",
        void 0
      ),
      ...
      rz = S = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: ro })], rz);
      class rW {
        constructor(e = {}) {
        ...
        isEqual(e) {
          return (
            ...
            ((e.parameters &&
              this.parameters &&
              ee.n4(e.parameters, this.parameters)) ||
      ...
      class rq {
        constructor(e = {}) {
          (this.algorithm = new rW()),
            (this.subjectPublicKey = new ArrayBuffer(0)),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)([tQ({ type: rW })], rq.prototype, "algorithm", void 0),
        (0, t8.Cg)(
          [tQ({ type: n.BitString })],
          rq.prototype,
          "subjectPublicKey",
      ...
      (0, t8.Cg)([tQ({ type: n.UTCTime })], rK.prototype, "utcTime", void 0),
        (0, t8.Cg)(
          [tQ({ type: n.GeneralizedTime })],
          rK.prototype,
          "generalTime",
        ...
        (rK = (0, t8.Cg)([tJ({ type: i.Choice })], rK));
      class rG {
        constructor(e) {
          (this.notBefore = new rK(new Date())),
            (this.notAfter = new rK(new Date())),
            e &&
              ((this.notBefore = new rK(e.notBefore)),
              (this.notAfter = new rK(e.notAfter)));
        }
      }
      (0, t8.Cg)([tQ({ type: rK })], rG.prototype, "notBefore", void 0),
        (0, t8.Cg)([tQ({ type: rK })], rG.prototype, "notAfter", void 0);
      class rY {
        constructor(e = {}) {
          (this.extnID = ""),
            (this.critical = rY.CRITICAL),
            (this.extnValue = new tk()),
            Object.assign(this, e);
        }
      }
      (rY.CRITICAL = !1),
        ...
        (0, t8.Cg)(
          [tQ({ type: n.Boolean, defaultValue: rY.CRITICAL })],
          rY.prototype,
          "critical",
          void 0
        ),
        (0, t8.Cg)([tQ({ type: tk })], rY.prototype, "extnValue", void 0);
      let rJ = (C = class extends t2 {
        constructor(e) {
          super(e), Object.setPrototypeOf(this, C.prototype);
        }
      });
      (rJ = C = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: rY })], rJ)),
        (function (e) {
          (e[(e.v1 = 0)] = "v1"),
            (e[(e.v2 = 1)] = "v2"),
            (e[(e.v3 = 2)] = "v3");
      ...
      class rQ {
        constructor(e = {}) {
          (this.version = I.v1),
            ...
            (this.signature = new rW()),
            (this.issuer = new rr()),
            (this.validity = new rG()),
            (this.subject = new rr()),
            (this.subjectPublicKeyInfo = new rq()),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)(
        [tQ({ type: n.Integer, context: 0, defaultValue: I.v1 })],
        rQ.prototype,
        "version",
        void 0
      ),
        ...
        (0, t8.Cg)([tQ({ type: rW })], rQ.prototype, "signature", void 0),
        (0, t8.Cg)([tQ({ type: rr })], rQ.prototype, "issuer", void 0),
        (0, t8.Cg)([tQ({ type: rG })], rQ.prototype, "validity", void 0),
        (0, t8.Cg)([tQ({ type: rr })], rQ.prototype, "subject", void 0),
        (0, t8.Cg)(
          [tQ({ type: rq })],
          rQ.prototype,
        ...
        (0, t8.Cg)(
          [tQ({ type: n.BitString, context: 1, implicit: !0, optional: !0 })],
          rQ.prototype,
          "issuerUniqueID",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.BitString, context: 2, implicit: !0, optional: !0 })],
          rQ.prototype,
          "subjectUniqueID",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: rJ, context: 3, optional: !0 })],
          rQ.prototype,
          "extensions",
          void 0
        );
      class rX {
        constructor(e = {}) {
          (this.tbsCertificate = new rQ()),
            (this.signatureAlgorithm = new rW()),
            (this.signatureValue = new ArrayBuffer(0)),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)([tQ({ type: rQ })], rX.prototype, "tbsCertificate", void 0),
        (0, t8.Cg)(
          [tQ({ type: rW })],
          rX.prototype,
          "signatureAlgorithm",
      ...
      (0, t8.Cg)(
        ...
        (0, t8.Cg)([tQ({ type: rK })], r0.prototype, "revocationDate", void 0),
        (0, t8.Cg)(
          [tQ({ type: rY, optional: !0, repeated: "sequence" })],
          r0.prototype,
          "crlEntryExtensions",
          void 0
        );
      ...
      (0, t8.Cg)(
        ...
        (0, t8.Cg)([tQ({ type: rW })], r1.prototype, "signature", void 0),
        (0, t8.Cg)([tQ({ type: rr })], r1.prototype, "issuer", void 0),
        (0, t8.Cg)([tQ({ type: rK })], r1.prototype, "thisUpdate", void 0),
        (0, t8.Cg)(
          [tQ({ type: rK, optional: !0 })],
          r1.prototype,
          "nextUpdate",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: r0, repeated: "sequence", optional: !0 })],
          r1.prototype,
          "revokedCertificates",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: rY, optional: !0, context: 0, repeated: "sequence" })],
          r1.prototype,
          "crlExtensions",
          void 0
        );
      ...
      function r6(e) {
        return new rW({ algorithm: e });
      }
      (0, t8.Cg)([tQ({ type: r1 })], r2.prototype, "tbsCertList", void 0),
        (0, t8.Cg)(
          [tQ({ type: rW })],
          r2.prototype,
          "signatureAlgorithm",
        ...
        r6("1.2.840.10045.4.1"),
        r6("1.2.840.10045.4.3.1"),
        r6("1.2.840.10045.4.3.2"),
        r6("1.2.840.10045.4.3.3"),
        r6("1.2.840.10045.4.3.4");
      let r8 = class {
        constructor(e = {}) {
          Object.assign(this, e);
        }
      ...
      (0, t8.Cg)(
        ...
        (r8 = (0, t8.Cg)([tJ({ type: i.Choice })], r8));
      class r4 {
        constructor(e = {}) {
          (this.version = 1),
            (this.privateKey = new tk()),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)([tQ({ type: n.Integer })], r4.prototype, "version", void 0),
        (0, t8.Cg)([tQ({ type: tk })], r4.prototype, "privateKey", void 0),
        (0, t8.Cg)(
          [tQ({ type: r8, context: 0, optional: !0 })],
          r4.prototype,
          "parameters",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.BitString, context: 1, optional: !0 })],
          r4.prototype,
          "publicKey",
          void 0
        );
      ...
      let r3 = "1.2.840.113549.1.1",
        ...
        ic = `${r3}.8`;
      function id(e) {
        return new rW({ algorithm: e, parameters: null });
      }
      ...
      id("2.16.840.1.101.3.4.2.4"),
        ...
        id("2.16.840.1.101.3.4.2.5"),
        id("2.16.840.1.101.3.4.2.6");
      let ip = new rW({ algorithm: ic, parameters: t6.serialize(ih) }),
        ig = new rW({
          algorithm: ie,
          parameters: t6.serialize(
            tT.toASN(
              new Uint8Array([
                218, 57, 163, 238, 94, 107, 75, 13, 50, 85, 191, 239, 149, 96,
                24, 144, 175, 216, 7, 9,
              ]).buffer
            )
          ),
      ...
      class iy {
        constructor(e = {}) {
          (this.hashAlgorithm = new rW(ih)),
            (this.maskGenAlgorithm = new rW({
              algorithm: ic,
              parameters: t6.serialize(ih),
            })),
            (this.pSourceAlgorithm = new rW(ig)),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)(
        [tQ({ type: rW, context: 0, defaultValue: ih })],
        iy.prototype,
        "hashAlgorithm",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: rW, context: 1, defaultValue: ip })],
          iy.prototype,
          "maskGenAlgorithm",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: rW, context: 2, defaultValue: ig })],
          iy.prototype,
          "pSourceAlgorithm",
          void 0
        ),
        new rW({ algorithm: r7, parameters: t6.serialize(new iy()) });
      class im {
        constructor(e = {}) {
          (this.hashAlgorithm = new rW(ih)),
            (this.maskGenAlgorithm = new rW({
      ...
      (0, t8.Cg)(
        ...
        (0, t8.Cg)(
          [tQ({ type: n.Integer, context: 2, defaultValue: 20 })],
          im.prototype,
          "saltLength",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: n.Integer, context: 3, defaultValue: 1 })],
          im.prototype,
          "trailerField",
          void 0
        ),
        new rW({ algorithm: it, parameters: t6.serialize(new im()) });
      class iv {
        constructor(e = {}) {
          (this.digestAlgorithm = new rW()),
            (this.digest = new tk()),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)([tQ({ type: rW })], iv.prototype, "digestAlgorithm", void 0),
        (0, t8.Cg)([tQ({ type: tk })], iv.prototype, "digest", void 0);
      class ib {
        constructor(e = {}) {
      ...
      iw = B = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: ib })], iw);
      class ix {
        constructor(e = {}) {
          (this.version = 0),
      ...
      (0, t8.Cg)([tQ({ type: n.Integer })], ix.prototype, "version", void 0),
        (0, t8.Cg)(
          [tQ({ type: n.Integer, converter: tI })],
          ix.prototype,
          "modulus",
      ...
      (0, t8.Cg)(
        ...
        (function (e) {
          (e[(e.verified = 0)] = "verified"),
            (e[(e.selfSigned = 1)] = "selfSigned"),
            (e[(e.unverified = 2)] = "unverified"),
            (e[(e.failed = 3)] = "failed");
        })(_ || (_ = {}));
      class iA {
        constructor(e = {}) {
          (this.verifiedBootKey = new tk()),
            (this.deviceLocked = !1),
            (this.verifiedBootState = _.verified),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)([tQ({ type: tk })], iA.prototype, "verifiedBootKey", void 0),
        (0, t8.Cg)(
          [tQ({ type: n.Boolean })],
          iA.prototype,
          "deviceLocked",
        ...
        (0, t8.Cg)(
          [tQ({ type: n.Enumerated })],
          iA.prototype,
          "verifiedBootState",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ type: tk, optional: !0 })],
          iA.prototype,
          "verifiedBootHash",
          void 0
        );
      ...
      iS = E = (0, t8.Cg)([tJ({ type: i.Set, itemType: n.Integer })], iS);
      class iC {
        constructor(e = {}) {
          Object.assign(this, e);
        }
      ...
      (0, t8.Cg)(
        [tQ({ context: 1, type: iS, optional: !0 })],
        iC.prototype,
        "purpose",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ context: 2, type: n.Integer, optional: !0 })],
          iC.prototype,
          "algorithm",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 3, type: n.Integer, optional: !0 })],
          iC.prototype,
          "keySize",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 5, type: iS, optional: !0 })],
          iC.prototype,
          "digest",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 6, type: iS, optional: !0 })],
          iC.prototype,
          "padding",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 10, type: n.Integer, optional: !0 })],
          iC.prototype,
          "ecCurve",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 200, type: n.Integer, optional: !0 })],
          iC.prototype,
          "rsaPublicExponent",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 203, type: iS, optional: !0 })],
          iC.prototype,
          "mgfDigest",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 303, type: n.Null, optional: !0 })],
          iC.prototype,
          "rollbackResistance",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 305, type: n.Null, optional: !0 })],
          iC.prototype,
          "earlyBootOnly",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 400, type: n.Integer, optional: !0 })],
          iC.prototype,
          "activeDateTime",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 401, type: n.Integer, optional: !0 })],
          iC.prototype,
          "originationExpireDateTime",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 402, type: n.Integer, optional: !0 })],
          iC.prototype,
          "usageExpireDateTime",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 405, type: n.Integer, optional: !0 })],
          iC.prototype,
          "usageCountLimit",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 503, type: n.Null, optional: !0 })],
          iC.prototype,
          "noAuthRequired",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 504, type: n.Integer, optional: !0 })],
          iC.prototype,
          "userAuthType",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 505, type: n.Integer, optional: !0 })],
          iC.prototype,
          "authTimeout",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 506, type: n.Null, optional: !0 })],
          iC.prototype,
          "allowWhileOnBody",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 507, type: n.Null, optional: !0 })],
          iC.prototype,
          "trustedUserPresenceRequired",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 508, type: n.Null, optional: !0 })],
          iC.prototype,
          "trustedConfirmationRequired",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 509, type: n.Null, optional: !0 })],
          iC.prototype,
          "unlockedDeviceRequired",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 600, type: n.Null, optional: !0 })],
          iC.prototype,
          "allApplications",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 601, type: tk, optional: !0 })],
          iC.prototype,
          "applicationId",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 701, type: n.Integer, optional: !0 })],
          iC.prototype,
          "creationDateTime",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 702, type: n.Integer, optional: !0 })],
          iC.prototype,
          "origin",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 703, type: n.Null, optional: !0 })],
          iC.prototype,
          "rollbackResistant",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 704, type: iA, optional: !0 })],
          iC.prototype,
          "rootOfTrust",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 705, type: n.Integer, optional: !0 })],
          iC.prototype,
          "osVersion",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 706, type: n.Integer, optional: !0 })],
          iC.prototype,
          "osPatchLevel",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 709, type: tk, optional: !0 })],
          iC.prototype,
          "attestationApplicationId",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 710, type: tk, optional: !0 })],
          iC.prototype,
          "attestationIdBrand",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 711, type: tk, optional: !0 })],
          iC.prototype,
          "attestationIdDevice",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 712, type: tk, optional: !0 })],
          iC.prototype,
          "attestationIdProduct",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 713, type: tk, optional: !0 })],
          iC.prototype,
          "attestationIdSerial",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 714, type: tk, optional: !0 })],
          iC.prototype,
          "attestationIdImei",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 715, type: tk, optional: !0 })],
          iC.prototype,
          "attestationIdMeid",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 716, type: tk, optional: !0 })],
          iC.prototype,
          "attestationIdManufacturer",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 717, type: tk, optional: !0 })],
          iC.prototype,
          "attestationIdModel",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 718, type: n.Integer, optional: !0 })],
          iC.prototype,
          "vendorPatchLevel",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 719, type: n.Integer, optional: !0 })],
          iC.prototype,
          "bootPatchLevel",
          void 0
        ),
        (0, t8.Cg)(
          [tQ({ context: 720, type: n.Null, optional: !0 })],
          iC.prototype,
          "deviceUniqueAttestation",
          void 0
        ),
        (function (e) {
          (e[(e.software = 0)] = "software"),
            (e[(e.trustedEnvironment = 1)] = "trustedEnvironment"),
            (e[(e.strongBox = 2)] = "strongBox");
        })(T || (T = {})),
        (function (e) {
          (e[(e.KM2 = 1)] = "KM2"),
            (e[(e.KM3 = 2)] = "KM3"),
            (e[(e.KM4 = 3)] = "KM4"),
            (e[(e.KM4_1 = 4)] = "KM4_1"),
            (e[(e.keyMint1 = 100)] = "keyMint1"),
            (e[(e.keyMint2 = 200)] = "keyMint2");
        })(N || (N = {}));
      class iI {
        constructor(e = {}) {
          (this.attestationVersion = N.KM4),
            (this.attestationSecurityLevel = T.software),
            (this.keymasterVersion = 0),
            (this.keymasterSecurityLevel = T.software),
            (this.attestationChallenge = new tk()),
            (this.uniqueId = new tk()),
            (this.softwareEnforced = new iC()),
            (this.teeEnforced = new iC()),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)(
        ...
        (0, t8.Cg)([tQ({ type: tk })], iI.prototype, "uniqueId", void 0),
        (0, t8.Cg)(
          [tQ({ type: iC })],
          iI.prototype,
          "softwareEnforced",
        ...
        (0, t8.Cg)([tQ({ type: iC })], iI.prototype, "teeEnforced", void 0);
      let iB = class extends iC {};
      iB = (0, t8.Cg)([tJ({ type: i.Choice })], iB);
      ...
      iE = O = (0, t8.Cg)([tJ({ type: i.Sequence, itemType: iB })], iE);
      class i_ {
        constructor(e = {}) {
          (this.attestationVersion = N.KM4),
            (this.attestationSecurityLevel = T.software),
            ...
            (this.attestationChallenge = new tk()),
            (this.uniqueId = new tk()),
            (this.softwareEnforced = new iE()),
            (this.teeEnforced = new iE()),
            Object.assign(this, e);
        }
      }
      (0, t8.Cg)(
        ...
        (0, t8.Cg)([tQ({ type: tk })], i_.prototype, "uniqueId", void 0),
        (0, t8.Cg)(
          [tQ({ type: iE })],
          i_.prototype,
          "softwareEnforced",
        ...
        (0, t8.Cg)([tQ({ type: iE })], i_.prototype, "teeEnforced", void 0);
      class iT {
        constructor(e = {}) {
          Object.assign(this, e);
        }
      ...
      (0, t8.Cg)(
        [tQ({ type: n.OctetString })],
        iT.prototype,
        "packageName",
        void 0
      ),
        (0, t8.Cg)([tQ({ type: n.Integer })], iT.prototype, "version", void 0);
      class iN {
        constructor(e = {}) {
          Object.assign(this, e);
        }
      ...
      (0, t8.Cg)(
        [tQ({ type: iT, repeated: "set" })],
        iN.prototype,
        "packageInfos",
        void 0
      ),
        (0, t8.Cg)(
          [tQ({ type: n.OctetString, repeated: "set" })],
          iN.prototype,
          "signatureDigests",
          void 0
        );
      !(function (e) {
        ...
        (function (e) {
          (e[(e.P256 = 1)] = "P256"),
            (e[(e.P384 = 2)] = "P384"),
            (e[(e.P521 = 3)] = "P521"),
            (e[(e.ED25519 = 6)] = "ED25519"),
            (e[(e.SECP256K1 = 8)] = "SECP256K1");
        })(Z || (Z = {})),
        !(function (e) {
          (e[(e.ES256 = -7)] = "ES256"),
            (e[(e.EdDSA = -8)] = "EdDSA"),
    ...
    86858: function (e, t, r) {
      ...
      (t.makeIssue = (e) => {
        let { data: t, path: r, errorMaps: i, issueData: n } = e,
          s = [...r, ...(n.path || [])],
          o = { ...n, path: s };
        if (void 0 !== n.message) return { ...n, path: s, message: n.message };
        let a = "";
        for (let e of i
          .filter((e) => !!e)
          .slice()
